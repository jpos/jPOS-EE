...
TIP: Windows Users can use Putty and use this link http://www.ualberta.ca/CNS/RESEARCH/LinuxClusters/pka-putty.html as a guide
to get the contents for the 'authorized_keys' file.
