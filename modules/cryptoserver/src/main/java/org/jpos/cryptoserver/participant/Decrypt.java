...
public class Decrypt implements TransactionParticipant, Configurable {
    ...
    public int prepare(long id, Serializable context) {
        ...
        if (cs.isLocked()) {
            ctx.put (RESPONSE, new Response(HttpResponseStatus.SERVICE_UNAVAILABLE, "Service unavailable - unlock required"));
            return FAIL;
        }
