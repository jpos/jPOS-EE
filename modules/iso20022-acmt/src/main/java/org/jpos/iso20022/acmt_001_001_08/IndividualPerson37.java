 ...
 *       <sequence>
 *         <element name="NmPrfx" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}NamePrefix1Choice" minOccurs="0"/>
 *         <element name="GvnNm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max35Text" minOccurs="0"/>
 *         <element name="MddlNm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max35Text" minOccurs="0"/>
 *         <element name="Nm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max350Text"/>
 *         <element name="NmSfx" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max35Text" minOccurs="0"/>
 *         <element name="Gndr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Gender1Code" minOccurs="0"/>
 *         <element name="BirthDt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}ISODate" minOccurs="0"/>
 *         <element name="CtryOfBirth" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}CountryCode" minOccurs="0"/>
 *         <element name="PrvcOfBirth" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max35Text" minOccurs="0"/>
 *         <element name="CityOfBirth" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max35Text" minOccurs="0"/>
 *         <element name="Prfssn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max35Text" minOccurs="0"/>
 *         <element name="PstlAdr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}PostalAddress21" maxOccurs="10"/>
 *         <element name="Ctznsh" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}CitizenshipInformation2" maxOccurs="3" minOccurs="0"/>
 *         <element name="EmplngCpny" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max140Text" minOccurs="0"/>
 *         <element name="BizFctn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max35Text" minOccurs="0"/>
 *         <element name="PltclyXpsdPrsn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}PoliticallyExposedPerson1" minOccurs="0"/>
 *         <element name="DthDt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}ISODate" minOccurs="0"/>
 *         <element name="CvlSts" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}CivilStatus1Choice" minOccurs="0"/>
 *         <element name="EdctnLvl" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}Max35Text" minOccurs="0"/>
 *         <element name="FmlyInf" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}PersonalInformation1" minOccurs="0"/>
 *         <element name="GDPRData" type="{urn:iso:std:iso:20022:tech:xsd:acmt.001.001.08}GDPRData1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
