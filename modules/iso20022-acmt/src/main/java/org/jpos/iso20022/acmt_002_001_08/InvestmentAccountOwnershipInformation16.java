 ...
 *       <sequence>
 *         <element name="Pty" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}Party47Choice"/>
 *         <element name="MnyLndrgChck" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}MoneyLaunderingCheck1Choice" minOccurs="0"/>
 *         <element name="InvstrPrflVldtn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}PartyProfileInformation5" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="OwnrshBnfcryRate" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}OwnershipBeneficiaryRate1" minOccurs="0"/>
 *         <element name="ClntId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}Max35Text" minOccurs="0"/>
 *         <element name="FsclXmptn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}YesNoIndicator" minOccurs="0"/>
 *         <element name="SgntryRghtInd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}YesNoIndicator" minOccurs="0"/>
 *         <element name="MiFIDClssfctn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}MiFIDClassification1" minOccurs="0"/>
 *         <element name="Ntfctn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}Notification2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FATCAFormTp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}FATCAForm1Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FATCASts" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}FATCAStatus2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FATCARptgDt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}ISODate" minOccurs="0"/>
 *         <element name="CRSFormTp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}CRSForm1Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CRSSts" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}CRSStatus4" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CRSRptgDt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}ISODate" minOccurs="0"/>
 *         <element name="OthrId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}GenericIdentification82" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="MailTp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}MailType1Choice" minOccurs="0"/>
 *         <element name="CtryAndResdtlSts" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}CountryAndResidentialStatusType2" minOccurs="0"/>
 *         <element name="MntryWlth" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}DateAndAmount1" minOccurs="0"/>
 *         <element name="EqtyVal" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}DateAndAmount1" minOccurs="0"/>
 *         <element name="WorkgCptl" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}DateAndAmount1" minOccurs="0"/>
 *         <element name="CpnyLk" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}CompanyLink1Choice" minOccurs="0"/>
 *         <element name="ElctrncMlngSvcRef" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}Max350Text" minOccurs="0"/>
 *         <element name="PmryComAdr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}CommunicationAddress6" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ScndryComAdr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}CommunicationAddress6" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlRgltryInf" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}RegulatoryInformation1" minOccurs="0"/>
 *         <element name="AcctgSts" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}AccountingStatus1Choice" minOccurs="0"/>
 *         <element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}AdditiononalInformation13" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CtrlgPty" type="{urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08}YesNoIndicator" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
