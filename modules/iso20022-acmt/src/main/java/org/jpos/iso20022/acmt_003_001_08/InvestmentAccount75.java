...
/**
 * <p>Java class for InvestmentAccount75 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="InvestmentAccount75">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="AcctStsUpdInstr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}AccountStatusUpdateInstruction1" minOccurs="0"/>
 ...
 *         <element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}AccountType2Choice" minOccurs="0"/>
 *         <element name="OwnrshTp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}OwnershipType2Choice" minOccurs="0"/>
 *         <element name="TaxXmptn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}TaxExemptionReason2Choice" minOccurs="0"/>
 *         <element name="StmtFrqcy" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}StatementFrequencyReason2Choice" minOccurs="0"/>
 *         <element name="RefCcy" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="Lang" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}LanguageCode" minOccurs="0"/>
 *         <element name="IncmPref" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}IncomePreference2Code" minOccurs="0"/>
 *         <element name="RinvstmtDtls" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}Reinvestment4" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TaxWhldgMtd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}TaxWithholdingMethod3Code" minOccurs="0"/>
 *         <element name="TaxRptg" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}TaxReporting3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="LttrInttDtls" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}LetterIntent1" minOccurs="0"/>
 *         <element name="AcmltnRghtRef" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}Max35Text" minOccurs="0"/>
 *         <element name="ReqrdSgntriesNb" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}Number" minOccurs="0"/>
 *         <element name="FndFmlyNm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}Max350Text" minOccurs="0"/>
 *         <element name="ModfdFinInstrmDtls" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}ModificationScope42" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="RndgDtls" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}RoundingParameters1" minOccurs="0"/>
 *         <element name="AcctSvcr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}PartyIdentification125Choice" minOccurs="0"/>
 *         <element name="BlckdSts" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}BlockedStatusReason2Choice" minOccurs="0"/>
 *         <element name="AcctUsgTp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}AccountUsageType2Choice" minOccurs="0"/>
 *         <element name="FrgnStsCertfctn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}Provided1Code" minOccurs="0"/>
 *         <element name="AcctSgntrDtTm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}DateAndDateTime1Choice" minOccurs="0"/>
 *         <element name="TxChanlTp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}TransactionChannelType1Choice" minOccurs="0"/>
 *         <element name="InvstmtAcctCtgy" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}InvestmentAccountCategory1Choice" minOccurs="0"/>
 *         <element name="Pldgg" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}Eligible1Code" minOccurs="0"/>
 *         <element name="Coll" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}Collateral1Code" minOccurs="0"/>
 *         <element name="ThrdPtyRghts" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}ThirdPartyRights2" minOccurs="0"/>
 *         <element name="PwrOfAttnyLvlOfCtrl" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}LevelOfControl1Choice" minOccurs="0"/>
 *         <element name="AcctgSts" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}AccountingStatus1Choice" minOccurs="0"/>
 *         <element name="OpngDt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}DateAndDateTime1Choice" minOccurs="0"/>
 *         <element name="ClsgDt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}DateAndDateTime1Choice" minOccurs="0"/>
 *         <element name="NegInd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}YesNoIndicator" minOccurs="0"/>
 *         <element name="PrcgOrdr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}PositionEffect3Code" minOccurs="0"/>
 *         <element name="Lblty" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}Liability1Choice" minOccurs="0"/>
 *         <element name="ModfdInvstrPrfl" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}ModificationScope46" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FsclYr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08}FiscalYear1Choice" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class InvestmentAccount75 {
     ...
     *     
     */
    public void setAcctStsUpdInstr(AccountStatusUpdateInstruction1 value) {
