...
/**
 * <p>Java class for AccountExcludedMandateMaintenanceRequestV03 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="AccountExcludedMandateMaintenanceRequestV03">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="Refs" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}References4"/>
 *         <element name="Fr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}OrganisationIdentification29" minOccurs="0"/>
 *         <element name="CtrctDts" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}AccountContract2" minOccurs="0"/>
 *         <element name="UndrlygMstrAgrmt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}ContractDocument1" minOccurs="0"/>
 *         <element name="Acct" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}CustomerAccountModification1"/>
 *         <element name="AcctSvcrId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}BranchAndFinancialInstitutionIdentification6"/>
 *         <element name="Org" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}OrganisationModification2"/>
 *         <element name="AddtlMsgInf" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}AdditionalInformation5" minOccurs="0"/>
 *         <element name="DgtlSgntr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}PartyAndSignature3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SplmtryData" type="{urn:iso:std:iso:20022:tech:xsd:acmt.015.001.03}SupplementaryData1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class AccountExcludedMandateMaintenanceRequestV03 {
     ...
     *     
     */
    public void setAcct(CustomerAccountModification1 value) {
        this.acct = value;
    }
     ...
     *     
     */
    public void setOrg(OrganisationModification2 value) {
        this.org = value;
    }
