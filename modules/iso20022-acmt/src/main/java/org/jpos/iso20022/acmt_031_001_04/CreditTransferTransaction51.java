 ...
 *       <sequence>
 *         <element name="PmtId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}PaymentIdentification6"/>
 *         <element name="PmtTpInf" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}PaymentTypeInformation26" minOccurs="0"/>
 *         <element name="TaxRateMrkr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}TaxRateMarker1Code" minOccurs="0"/>
 *         <element name="Amt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}ActiveCurrencyAndAmount"/>
 *         <element name="ChrgBr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}ChargeBearerType1Code" minOccurs="0"/>
 *         <element name="ChqInstr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}Cheque11" minOccurs="0"/>
 *         <element name="Frqcy" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}Frequency1" minOccurs="0"/>
 *         <element name="TrfInstr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}TransferInstruction1" minOccurs="0"/>
 *         <element name="UltmtDbtr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}PartyIdentification135" minOccurs="0"/>
 *         <element name="IntrmyAgt1" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="IntrmyAgt2" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="IntrmyAgt3" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="CdtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}BranchAndFinancialInstitutionIdentification6"/>
 *         <element name="Cdtr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}PartyIdentification135" minOccurs="0"/>
 *         <element name="CdtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}CashAccount40" minOccurs="0"/>
 *         <element name="UltmtCdtr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}PartyIdentification135" minOccurs="0"/>
 *         <element name="InstrForCdtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}InstructionForCreditorAgent3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Purp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}Purpose2Choice" minOccurs="0"/>
 *         <element name="RgltryRptg" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}RegulatoryReporting3" maxOccurs="10" minOccurs="0"/>
 *         <element name="Tax" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}TaxInformation10" minOccurs="0"/>
 *         <element name="RltdRmtInf" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}RemittanceLocation6" maxOccurs="10" minOccurs="0"/>
 *         <element name="RmtInf" type="{urn:iso:std:iso:20022:tech:xsd:acmt.031.001.04}RemittanceInformation21" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
