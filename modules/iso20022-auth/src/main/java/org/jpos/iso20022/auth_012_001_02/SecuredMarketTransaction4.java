...
/**
 * <p>Java class for SecuredMarketTransaction4 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="SecuredMarketTransaction4">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="RptdTxSts" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}TransactionOperationType1Code"/>
 *         <element name="NvtnSts" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}NovationStatus1Code" minOccurs="0"/>
 *         <element name="BrnchId" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}LEIIdentifier" minOccurs="0"/>
 *         <element name="UnqTxIdr" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}Max105Text" minOccurs="0"/>
 *         <element name="PrtryTxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}Max105Text"/>
 *         <element name="RltdPrtryTxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}Max105Text" minOccurs="0"/>
 *         <element name="CtrPtyPrtryTxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}Max105Text" minOccurs="0"/>
 *         <element name="CtrPtyId" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}CounterpartyIdentification3Choice"/>
 *         <element name="TrptyAgtId" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}LEIIdentifier" minOccurs="0"/>
 *         <element name="TradDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}DateAndDateTimeChoice"/>
 *         <element name="SttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}ISODate"/>
 *         <element name="MtrtyDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}ISODate"/>
 *         <element name="TxTp" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}MoneyMarketTransactionType1Code"/>
 *         <element name="TxNmnlAmt" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}ActiveCurrencyAndAmount"/>
 *         <element name="RateTp" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}InterestRateType1Code"/>
 *         <element name="DealRate" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}PercentageRate" minOccurs="0"/>
 *         <element name="FltgRateRpAgrmt" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}FloatingRateNote2" minOccurs="0"/>
 *         <element name="BrkrdDeal" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}BrokeredDeal1Code" minOccurs="0"/>
 *         <element name="Coll" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}Collateral18"/>
 *         <element name="SplmtryData" type="{urn:iso:std:iso:20022:tech:xsd:auth.012.001.02}SupplementaryData1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class SecuredMarketTransaction4 {
     ...
     *     
     */
    public void setFltgRateRpAgrmt(FloatingRateNote2 value) {
     ...
     *     
     */
    public void setColl(Collateral18 value) {
        this.coll = value;
    }
