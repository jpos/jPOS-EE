...
/**
 * <p>Java class for OvernightIndexSwapTransaction4 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="OvernightIndexSwapTransaction4">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="RptdTxSts" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}TransactionOperationType1Code"/>
 *         <element name="NvtnSts" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}NovationStatus1Code" minOccurs="0"/>
 *         <element name="BrnchId" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}LEIIdentifier" minOccurs="0"/>
 *         <element name="UnqTxIdr" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}Max105Text" minOccurs="0"/>
 *         <element name="PrtryTxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}Max105Text"/>
 *         <element name="RltdPrtryTxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}Max105Text" minOccurs="0"/>
 *         <element name="CtrPtyPrtryTxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}Max105Text" minOccurs="0"/>
 *         <element name="CtrPtyId" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}CounterpartyIdentification3Choice"/>
 *         <element name="TradDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}DateAndDateTimeChoice"/>
 *         <element name="StartDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}ISODate"/>
 *         <element name="MtrtyDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}ISODate"/>
 *         <element name="FxdIntrstRate" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}PercentageRate"/>
 *         <element name="TxTp" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}OvernightIndexSwapType1Code"/>
 *         <element name="TxNmnlAmt" type="{urn:iso:std:iso:20022:tech:xsd:auth.015.001.02}ActiveCurrencyAndAmount"/>
...
public class OvernightIndexSwapTransaction4 {
     ...
     *     
     */
    public void setTxTp(OvernightIndexSwapType1Code value) {
        this.txTp = value;
    }
