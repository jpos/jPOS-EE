 ...
 *       <sequence>
 *         <element name="CtrctDocId" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}DocumentIdentification22"/>
 *         <element name="LnTpId" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}Max35Text" minOccurs="0"/>
 *         <element name="Buyr" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}TradeParty5" maxOccurs="unbounded"/>
 *         <element name="Sellr" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}TradeParty5" maxOccurs="unbounded"/>
 *         <element name="Amt" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}ActiveCurrencyAndAmount" minOccurs="0"/>
 *         <element name="MtrtyDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}ISODate" minOccurs="0"/>
 *         <element name="PrlngtnFlg" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="StartDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}ISODate" minOccurs="0"/>
 *         <element name="SttlmCcy" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="SpclConds" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}SpecialCondition1" minOccurs="0"/>
 *         <element name="DrtnCd" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}Exact1NumericText" minOccurs="0"/>
 *         <element name="IntrstRate" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}InterestRate2Choice" minOccurs="0"/>
 *         <element name="Trch" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}LoanContractTranche1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PmtSchdl" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}PaymentSchedule1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="IntrstSchdl" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}InterestPaymentSchedule1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="IntraCpnyLn" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}TrueFalseIndicator"/>
 *         <element name="Coll" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}ContractCollateral1" minOccurs="0"/>
 *         <element name="SndctdLn" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}SyndicatedLoan2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Attchmnt" type="{urn:iso:std:iso:20022:tech:xsd:auth.019.001.03}DocumentGeneralInformation5" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
