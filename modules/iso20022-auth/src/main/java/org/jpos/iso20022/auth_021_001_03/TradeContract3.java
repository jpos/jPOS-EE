 ...
 *       <sequence>
 *         <element name="CtrctDocId" type="{urn:iso:std:iso:20022:tech:xsd:auth.021.001.03}DocumentIdentification22" minOccurs="0"/>
 *         <element name="TradTpId" type="{urn:iso:std:iso:20022:tech:xsd:auth.021.001.03}Max35Text" minOccurs="0"/>
 ...
 *         <element name="XchgRateInf" type="{urn:iso:std:iso:20022:tech:xsd:auth.021.001.03}ExchangeRate1" minOccurs="0"/>
 *         <element name="PmtSchdl" type="{urn:iso:std:iso:20022:tech:xsd:auth.021.001.03}InterestPaymentDateRange1" minOccurs="0"/>
 *         <element name="ShipmntSchdl" type="{urn:iso:std:iso:20022:tech:xsd:auth.021.001.03}ShipmentSchedule2Choice" minOccurs="0"/>
