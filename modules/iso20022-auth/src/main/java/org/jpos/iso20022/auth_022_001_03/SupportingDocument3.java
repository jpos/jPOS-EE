 ...
 *       <sequence>
 *         <element name="SpprtgDocId" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}Max35Text"/>
 *         <element name="OrgnlReqId" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}Max35Text" minOccurs="0"/>
 *         <element name="Cert" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}DocumentIdentification28"/>
 *         <element name="AcctOwnr" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}PartyIdentification135"/>
 *         <element name="AcctSvcr" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}BranchAndFinancialInstitutionIdentification6"/>
 *         <element name="Amdmnt" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}DocumentAmendment1" minOccurs="0"/>
 *         <element name="CtrctRef" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}ContractRegistrationReference2Choice"/>
 *         <element name="Ntry" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}SupportingDocumentEntry2" maxOccurs="unbounded"/>
