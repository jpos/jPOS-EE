 ...
 *       <sequence>
 *         <element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}Max35Text"/>
 *         <element name="Cert" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}DocumentIdentification28"/>
 *         <element name="Acct" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}CashAccount40" minOccurs="0"/>
 *         <element name="BkAcctDmcltnCtry" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}CountryCode" minOccurs="0"/>
 *         <element name="Amdmnt" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}DocumentAmendment1" minOccurs="0"/>
 *         <element name="CertRcrd" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}TransactionCertificateRecord2" maxOccurs="unbounded"/>
