 ...
 *       <sequence>
 *         <element name="CtrctRef" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}ContractRegistrationReference2Choice" minOccurs="0"/>
 *         <element name="TxAmtInCtrctCcy" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}ActiveCurrencyAndAmount" minOccurs="0"/>
 *         <element name="XpctdShipmntDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}ISODate" minOccurs="0"/>
 *         <element name="XpctdAdvncPmtRtrDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.022.001.03}ISODate" minOccurs="0"/>
