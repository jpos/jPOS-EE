 ...
 *       <choice>
 *         <element name="Agrcltrl" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityAgricultural6Choice"/>
 *         <element name="Nrgy" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityEnergy3Choice"/>
 *         <element name="Envttl" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityEnvironmental3Choice"/>
 *         <element name="Frtlzr" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityFertilizer4Choice"/>
 *         <element name="Frght" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityFreight4Choice"/>
 *         <element name="Indx" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityIndex1"/>
 *         <element name="IndstrlPdct" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityIndustrialProduct2Choice"/>
 *         <element name="Infltn" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityInflation1"/>
 *         <element name="Metl" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityMetal2Choice"/>
 *         <element name="MultiCmmdtyExtc" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityMultiCommodityExotic1"/>
 *         <element name="OffclEcnmcSttstcs" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityOfficialEconomicStatistics1"/>
 *         <element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityOther1"/>
 *         <element name="OthrC10" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityC10Other1"/>
 *         <element name="Ppr" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityPaper4Choice"/>
 *         <element name="Plprpln" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodityPolypropylene4Choice"/>
 *       </choice>
 *     </restriction>
 *   </complexContent>
 * </complexType>
