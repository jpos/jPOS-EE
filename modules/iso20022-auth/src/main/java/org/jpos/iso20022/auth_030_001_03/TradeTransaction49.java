 ...
 *       <sequence>
 *         <element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}UniqueTransactionIdentifier2Choice" minOccurs="0"/>
 *         <element name="PrrTxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}UniqueTransactionIdentifier3Choice" minOccurs="0"/>
 *         <element name="SbsqntTxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}UniqueTransactionIdentifier3Choice" minOccurs="0"/>
 *         <element name="CollPrtflCd" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}CollateralPortfolioCode5Choice" minOccurs="0"/>
 *         <element name="RptTrckgNb" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}Max52Text" minOccurs="0"/>
 *         <element name="PltfmIdr" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}MICIdentifier" minOccurs="0"/>
 *         <element name="MrrrOrTrggrTx" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="TxPric" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}PriceData2" minOccurs="0"/>
 *         <element name="NtnlAmt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}NotionalAmountLegs5" minOccurs="0"/>
 *         <element name="NtnlQty" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}NotionalQuantityLegs5" minOccurs="0"/>
 *         <element name="Qty" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}FinancialInstrumentQuantity32Choice" minOccurs="0"/>
 *         <element name="DlvryTp" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}PhysicalTransferType4Code" minOccurs="0"/>
 *         <element name="ExctnTmStmp" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}ISODateTime" minOccurs="0"/>
 *         <element name="FctvDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}ISODate" minOccurs="0"/>
 *         <element name="XprtnDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}ISODate" minOccurs="0"/>
 *         <element name="EarlyTermntnDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}ISODate" minOccurs="0"/>
 *         <element name="SttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}ISODate" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="MstrAgrmt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}MasterAgreement8" minOccurs="0"/>
 *         <element name="Cmprssn" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="PstTradRskRdctnFlg" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="PstTradRskRdctnEvt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}PTRREvent2" minOccurs="0"/>
 *         <element name="DerivEvt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}DerivativeEvent6" minOccurs="0"/>
 *         <element name="TradConf" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}TradeConfirmation1Choice" minOccurs="0"/>
 *         <element name="NonStdsdTerm" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="TradClr" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}TradeClearing11" minOccurs="0"/>
 *         <element name="BlckTradElctn" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="LrgNtnlOffFcltyElctn" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="IntrstRate" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}InterestRateLegs14" minOccurs="0"/>
 *         <element name="Ccy" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}CurrencyExchange22" minOccurs="0"/>
 *         <element name="Cmmdty" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AssetClassCommodity6Choice" minOccurs="0"/>
 *         <element name="Optn" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}OptionOrSwaption10" minOccurs="0"/>
 *         <element name="NrgySpcfcAttrbts" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}EnergySpecificAttribute9" minOccurs="0"/>
 *         <element name="Cdt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}CreditDerivative4" minOccurs="0"/>
 *         <element name="OthrPmt" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}OtherPayment5" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Packg" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}Package4" minOccurs="0"/>
 *         <element name="TradAllcnSts" type="{urn:iso:std:iso:20022:tech:xsd:auth.030.001.03}AllocationIndicator1Code" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
