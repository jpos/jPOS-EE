 ...
 *       <choice>
 *         <element name="Agrcltrl" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityAgricultural1Choice"/>
 *         <element name="Nrgy" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityEnergy1Choice"/>
 *         <element name="Envttl" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityEnvironmental1Choice"/>
 *         <element name="Frtlzr" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityFertilizer1Choice"/>
 *         <element name="Frght" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityFreight1Choice"/>
 *         <element name="IndstrlPdct" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityIndustrialProduct1Choice"/>
 *         <element name="Metl" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityMetal1Choice"/>
 *         <element name="OthrC10" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityOtherC102Choice"/>
 *         <element name="Ppr" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityPaper1Choice"/>
 *         <element name="Plprpln" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityPolypropylene1Choice"/>
 *         <element name="Infltn" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityInflation1"/>
 *         <element name="MultiCmmdtyExtc" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityMultiCommodityExotic1"/>
 *         <element name="OffclEcnmcSttstcs" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityOfficialEconomicStatistics1"/>
 *         <element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}AssetClassCommodityOther1"/>
 *       </choice>
 *     </restriction>
 *   </complexContent>
 * </complexType>
