 ...
 *         <element name="FinInstrmGnlAttrbts" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}SecurityInstrumentDescription9"/>
 *         <element name="Issr" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}LEIIdentifier"/>
 *         <element name="TradgVnRltdAttrbts" type="{urn:iso:std:iso:20022:tech:xsd:auth.036.001.03}TradingVenueAttributes1" maxOccurs="unbounded"/>
