 ...
 *         <element name="ExctnDtTm" type="{urn:iso:std:iso:20022:tech:xsd:auth.052.001.02}ISODateTime" minOccurs="0"/>
 ...
 *         <element name="OutsdngMrgnLnAmt" type="{urn:iso:std:iso:20022:tech:xsd:auth.052.001.02}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="ShrtMktValAmt" type="{urn:iso:std:iso:20022:tech:xsd:auth.052.001.02}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="MrgnLnAttr" type="{urn:iso:std:iso:20022:tech:xsd:auth.052.001.02}InterestRate6" maxOccurs="unbounded" minOccurs="0"/>
