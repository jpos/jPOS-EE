 ...
 *       <sequence>
 *         <element name="Ctry" type="{urn:iso:std:iso:20022:tech:xsd:auth.077.001.01}CountryCode" minOccurs="0"/>
 *         <element name="CmptntAuthrty" type="{urn:iso:std:iso:20022:tech:xsd:auth.077.001.01}SupervisingAuthorityIdentification1"/>
 *         <element name="Sts" type="{urn:iso:std:iso:20022:tech:xsd:auth.077.001.01}Max10Text" minOccurs="0"/>
 *         <element name="StsRsn" type="{urn:iso:std:iso:20022:tech:xsd:auth.077.001.01}Max10Text"/>
 *         <element name="ActvtyPrd" type="{urn:iso:std:iso:20022:tech:xsd:auth.077.001.01}Period4Choice" minOccurs="0"/>
