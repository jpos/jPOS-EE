 ...
 *       <choice>
 *         <element name="Agrcltrl" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityAgricultural5Choice"/>
 *         <element name="Nrgy" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityEnergy2Choice"/>
 *         <element name="Envttl" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityEnvironmental2Choice"/>
 *         <element name="Frtlzr" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityFertilizer3Choice"/>
 *         <element name="Frght" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityFreight3Choice"/>
 *         <element name="IndstrlPdct" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityIndustrialProduct1Choice"/>
 *         <element name="Metl" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityMetal1Choice"/>
 *         <element name="OthrC10" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityOtherC102Choice"/>
 *         <element name="Ppr" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityPaper3Choice"/>
 *         <element name="Plprpln" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityPolypropylene3Choice"/>
 *         <element name="Infltn" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityInflation1"/>
 *         <element name="MultiCmmdtyExtc" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityMultiCommodityExotic1"/>
 *         <element name="OffclEcnmcSttstcs" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityOfficialEconomicStatistics1"/>
 *         <element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}AssetClassCommodityOther1"/>
 *       </choice>
 *     </restriction>
 *   </complexContent>
 * </complexType>
