 ...
 *       <sequence>
 *         <element name="RefRate" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}BenchmarkCurveName10Choice" minOccurs="0"/>
 *         <element name="Term" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}InterestRateContractTerm2" minOccurs="0"/>
 *         <element name="PmtFrqcy" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}InterestRateContractTerm2" minOccurs="0"/>
 *         <element name="RstFrqcy" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}InterestRateContractTerm2" minOccurs="0"/>
 *         <element name="Sprd" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}SecuritiesTransactionPrice18Choice" minOccurs="0"/>
 *         <element name="RateAdjstmnt" type="{urn:iso:std:iso:20022:tech:xsd:auth.079.001.02}RateAdjustment1" maxOccurs="unbounded" minOccurs="0"/>
