...
/**
 * <p>Java class for ReuseDataReportCorrection15 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="ReuseDataReportCorrection15">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="TechRcrdId" type="{urn:iso:std:iso:20022:tech:xsd:auth.086.001.02}Max140Text" minOccurs="0"/>
 *         <element name="CtrPty" type="{urn:iso:std:iso:20022:tech:xsd:auth.086.001.02}CounterpartyData87"/>
 *         <element name="CollCmpnt" type="{urn:iso:std:iso:20022:tech:xsd:auth.086.001.02}CollateralType19" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="EvtDay" type="{urn:iso:std:iso:20022:tech:xsd:auth.086.001.02}ISODate"/>
 *         <element name="RptgDtTm" type="{urn:iso:std:iso:20022:tech:xsd:auth.086.001.02}ISODateTime"/>
 *         <element name="FndgSrc" type="{urn:iso:std:iso:20022:tech:xsd:auth.086.001.02}FundingSource3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="RcncltnFlg" type="{urn:iso:std:iso:20022:tech:xsd:auth.086.001.02}ReconciliationFlag2" minOccurs="0"/>
 *         <element name="CtrctMod" type="{urn:iso:std:iso:20022:tech:xsd:auth.086.001.02}ContractModification3"/>
 *         <element name="SplmtryData" type="{urn:iso:std:iso:20022:tech:xsd:auth.086.001.02}SupplementaryData1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
