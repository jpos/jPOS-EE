 ...
 *       <choice>
 *         <element name="Elctrcty" type="{urn:iso:std:iso:20022:tech:xsd:auth.091.001.02}EnergyCommodityElectricity2"/>
 *         <element name="NtrlGas" type="{urn:iso:std:iso:20022:tech:xsd:auth.091.001.02}EnergyCommodityNaturalGas3"/>
 *         <element name="Oil" type="{urn:iso:std:iso:20022:tech:xsd:auth.091.001.02}EnergyCommodityOil3"/>
 *         <element name="Coal" type="{urn:iso:std:iso:20022:tech:xsd:auth.091.001.02}EnergyCommodityCoal2"/>
 *         <element name="IntrNrgy" type="{urn:iso:std:iso:20022:tech:xsd:auth.091.001.02}EnergyCommodityInterEnergy2"/>
 *         <element name="RnwblNrgy" type="{urn:iso:std:iso:20022:tech:xsd:auth.091.001.02}EnergyCommodityRenewableEnergy2"/>
 *         <element name="LghtEnd" type="{urn:iso:std:iso:20022:tech:xsd:auth.091.001.02}EnergyCommodityLightEnd2"/>
 *         <element name="Dstllts" type="{urn:iso:std:iso:20022:tech:xsd:auth.091.001.02}EnergyCommodityDistillates2"/>
 *         <element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:auth.091.001.02}EnergyCommodityOther2"/>
 *       </choice>
 *     </restriction>
 *   </complexContent>
 * </complexType>
