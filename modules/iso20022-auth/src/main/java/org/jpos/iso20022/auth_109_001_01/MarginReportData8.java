...
/**
 * <p>Java class for MarginReportData8 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="MarginReportData8">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="RptgTmStmp" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}ISODateTime" minOccurs="0"/>
 *         <element name="CtrPtyId" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}TradeCounterpartyReport20"/>
 *         <element name="EvtDt" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}ISODate" minOccurs="0"/>
 *         <element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}UniqueTransactionIdentifier2Choice" minOccurs="0"/>
 *         <element name="Coll" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}MarginCollateralReport4"/>
 *         <element name="PstdMrgnOrColl" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}PostedMarginOrCollateral6" minOccurs="0"/>
 *         <element name="RcvdMrgnOrColl" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}ReceivedMarginOrCollateral6" minOccurs="0"/>
 *         <element name="CtrPtyRatgTrggrInd" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CtrPtyRatgThrshldInd" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CtrctMod" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}ContractModification8" minOccurs="0"/>
 *         <element name="TechAttrbts" type="{urn:iso:std:iso:20022:tech:xsd:auth.109.001.01}TechnicalAttributes6" minOccurs="0"/>
...
public class MarginReportData8 {
     ...
     *     
     */
    public void setCtrctMod(ContractModification8 value) {
        this.ctrctMod = value;
    }
