 ...
 *       <sequence>
 *         <element name="Ccy" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="TtlAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}ImpliedCurrencyAndAmount"/>
 *         <element name="CmltvAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="AmtQlfr" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}TypeOfAmount8Code" minOccurs="0"/>
 *         <element name="DtldAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}DetailedAmount15" minOccurs="0"/>
 *         <element name="ReqdAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="AuthrsdAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="InvcAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="VldtyDt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}ISODate" minOccurs="0"/>
 *         <element name="OnLineRsn" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}OnLineReason2Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="UattnddLvlCtgy" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}Max35NumericText" minOccurs="0"/>
 *         <element name="AcctTp" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}CardAccountType3Code" minOccurs="0"/>
 *         <element name="CcyConvsRslt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}CurrencyConversion27" minOccurs="0"/>
 *         <element name="Instlmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}RecurringTransaction5" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AggtnTx" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}AggregationTransaction3" minOccurs="0"/>
 *         <element name="PdctCdSetId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}Max10Text" minOccurs="0"/>
 *         <element name="SaleItm" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}Product6" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="DlvryLctn" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}Max35Text" minOccurs="0"/>
 *         <element name="ReSubmissnCntr" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}PositiveNumber" minOccurs="0"/>
 *         <element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}ExternallyDefinedData4" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ICCRltdData" type="{urn:iso:std:iso:20022:tech:xsd:caaa.016.001.10}Max10000Binary" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
