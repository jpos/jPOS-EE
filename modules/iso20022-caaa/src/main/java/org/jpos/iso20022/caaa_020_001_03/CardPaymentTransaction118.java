...
/**
 * <p>Java class for CardPaymentTransaction118 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="CardPaymentTransaction118">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="TxCaptr" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="TxTp" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}CardPaymentServiceType12Code" minOccurs="0"/>
 *         <element name="AddtlSvc" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}CardPaymentServiceType9Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SvcAttr" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}CardPaymentServiceType14Code" minOccurs="0"/>
 *         <element name="LastTxFlg" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="MrchntCtgyCd" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Min3Max4Text" minOccurs="0"/>
 *         <element name="CstmrCnsnt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CardPrgrmmPropsd" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CardPrgrmmApld" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max35Text" minOccurs="0"/>
 *         <element name="SaleRefId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max35Text" minOccurs="0"/>
 *         <element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}TransactionIdentifier1"/>
 *         <element name="OrgnlTx" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}CardPaymentTransaction122" minOccurs="0"/>
 *         <element name="TxSucss" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}TrueFalseIndicator"/>
 *         <element name="Rvsl" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="MrchntOvrrd" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="FailrRsn" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}FailureReason3Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="InitrTxId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max35Text" minOccurs="0"/>
 *         <element name="RcptTxId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max140Text" minOccurs="0"/>
 *         <element name="RcncltnId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max35Text" minOccurs="0"/>
 *         <element name="IntrchngData" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max140Text" minOccurs="0"/>
 *         <element name="IssrCITId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max140Text" minOccurs="0"/>
 *         <element name="MrchntCITId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max140Text" minOccurs="0"/>
 *         <element name="TxDtls" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}CardPaymentTransactionDetails51"/>
 *         <element name="AuthstnRslt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}AuthorisationResult18" minOccurs="0"/>
 *         <element name="TxVrfctnRslt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}TransactionVerificationResult4" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="MrchntRefData" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max70Text" minOccurs="0"/>
 *         <element name="AcctFr" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}CardAccount16" minOccurs="0"/>
 *         <element name="AcctTo" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}CardAccount16" minOccurs="0"/>
 *         <element name="AddtlTxData" type="{urn:iso:std:iso:20022:tech:xsd:caaa.020.001.03}Max70Text" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class CardPaymentTransaction118 {
     ...
     *     
     */
    public void setTxDtls(CardPaymentTransactionDetails51 value) {
        this.txDtls = value;
    }
