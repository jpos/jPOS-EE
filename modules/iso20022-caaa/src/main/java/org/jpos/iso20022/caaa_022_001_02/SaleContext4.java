 ...
 *       <sequence>
 *         <element name="SaleId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Max35Text" minOccurs="0"/>
 *         <element name="SaleRefNb" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Max35Text" minOccurs="0"/>
 *         <element name="SaleRcncltnId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Max35Text" minOccurs="0"/>
 *         <element name="CshrId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Max35Text" minOccurs="0"/>
 *         <element name="CshrLang" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}LanguageCode" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ShftNb" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Max2NumericText" minOccurs="0"/>
 *         <element name="CstmrOrdrReqFlg" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="PurchsOrdrNb" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Max35Text" minOccurs="0"/>
 *         <element name="InvcNb" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Max35Text" minOccurs="0"/>
 *         <element name="DlvryNoteNb" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Max35Text" minOccurs="0"/>
 *         <element name="SpnsrdMrchnt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Organisation26" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SpltPmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="RmngAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="ForceOnlnFlg" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="ReuseCardDataFlg" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="AllwdNtryMd" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}CardDataReading8Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SaleTknScp" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}SaleTokenScope1Code" minOccurs="0"/>
 *         <element name="AddtlSaleData" type="{urn:iso:std:iso:20022:tech:xsd:caaa.022.001.02}Max70Text" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
