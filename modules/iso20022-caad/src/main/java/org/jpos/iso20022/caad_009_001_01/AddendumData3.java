 ...
 *       <sequence>
 *         <element name="PurchsIdrTp" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}PurchaseIdentifierType1Code" minOccurs="0"/>
 *         <element name="OthrPurchsIdrTp" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Max35Text" minOccurs="0"/>
 *         <element name="PurchsIdr" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Max99Text" minOccurs="0"/>
 *         <element name="AddtlAccptrData" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}AdditionalAcceptorData1" minOccurs="0"/>
 *         <element name="Cstmr" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Customer4" minOccurs="0"/>
 *         <element name="Sale" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Sale2" minOccurs="0"/>
 *         <element name="Fleet" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}FleetData4" minOccurs="0"/>
 *         <element name="Invc" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Invoice2" minOccurs="0"/>
 *         <element name="TrvlAgcy" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}TravelAgency3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PssngrTrnsprt" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}PassengerTransport2" minOccurs="0"/>
 *         <element name="VhclRntl" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}VehicleRentalService2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Ldgg" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Lodging3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ShppgData" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}ShippingData2" minOccurs="0"/>
 *         <element name="TelecomSvcs" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}TelecomServices2" minOccurs="0"/>
 *         <element name="TempSvcs" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}TemporaryServices2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Instlmt" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Instalment4" minOccurs="0"/>
