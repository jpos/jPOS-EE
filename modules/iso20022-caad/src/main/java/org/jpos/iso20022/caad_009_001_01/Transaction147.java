 ...
 *       <sequence>
 *         <element name="TxTp" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}ISO8583TransactionTypeCode" minOccurs="0"/>
 *         <element name="TxSubTp" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Max35Text" minOccurs="0"/>
 *         <element name="TxAttr" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}TransactionAttribute2Code" minOccurs="0"/>
 *         <element name="OthrTxAttr" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Max35Text" minOccurs="0"/>
 *         <element name="MsgRsn" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}ISO8583MessageReasonCode" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AltrnMsgRsn" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PreAuthstnTmLmt" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Max6NumericText" minOccurs="0"/>
 *         <element name="AddtlSvc" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}AdditionalService2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AssoctdDataRef" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Max70Text" minOccurs="0"/>
 *         <element name="SpclPrgrmmQlfctn" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}SpecialProgrammeQualification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}TransactionIdentification18" minOccurs="0"/>
 *         <element name="DsptData" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}DisputeData3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TxAmts" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}TransactionAmounts2" minOccurs="0"/>
 *         <element name="AddtlAmt" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}AdditionalAmounts3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlFee" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}AdditionalFee2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="OrgnlAddtlFee" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}AdditionalFee2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="DpstDtls" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}DepositDetails2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FndsSvcs" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}FundingService2" minOccurs="0"/>
 *         <element name="AcctFr" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}AccountDetails3" minOccurs="0"/>
 *         <element name="AcctTo" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}AccountDetails3" minOccurs="0"/>
 *         <element name="TxDesc" type="{urn:iso:std:iso:20022:tech:xsd:caad.009.001.01}Max1000Text" minOccurs="0"/>
