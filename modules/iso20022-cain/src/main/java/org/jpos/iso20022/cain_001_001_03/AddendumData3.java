 ...
 *       <sequence>
 *         <element name="PurchsIdrTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}PurchaseIdentifierType1Code" minOccurs="0"/>
 *         <element name="OthrPurchsIdrTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="PurchsIdr" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max99Text" minOccurs="0"/>
 *         <element name="AddtlAccptrData" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}AdditionalAcceptorData1" minOccurs="0"/>
 *         <element name="Cstmr" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Customer4" minOccurs="0"/>
 *         <element name="Sale" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Sale2" minOccurs="0"/>
 *         <element name="Fleet" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}FleetData4" minOccurs="0"/>
 *         <element name="Invc" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Invoice2" minOccurs="0"/>
 *         <element name="TrvlAgcy" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TravelAgency3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PssngrTrnsprt" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}PassengerTransport2" minOccurs="0"/>
 *         <element name="VhclRntl" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}VehicleRentalService2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Ldgg" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Lodging3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ShppgData" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}ShippingData2" minOccurs="0"/>
 *         <element name="TelecomSvcs" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TelecomServices2" minOccurs="0"/>
 *         <element name="TempSvcs" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TemporaryServices2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Instlmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Instalment4" minOccurs="0"/>
