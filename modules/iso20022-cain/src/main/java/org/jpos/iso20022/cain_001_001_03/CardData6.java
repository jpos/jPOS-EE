 ...
 *       <sequence>
 *         <element name="PAN" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max19NumericText" minOccurs="0"/>
 *         <element name="PrtctdPANInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CardSeqNb" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Min2Max3NumericText" minOccurs="0"/>
 *         <element name="FctvDt" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}ISOYearMonth" minOccurs="0"/>
 *         <element name="XpryDt" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}ISOYearMonth" minOccurs="0"/>
 *         <element name="SvcCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Exact3NumericText" minOccurs="0"/>
 *         <element name="Trck1" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max76Text" minOccurs="0"/>
 *         <element name="Trck2" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Track2Data1Choice" minOccurs="0"/>
 *         <element name="Trck3" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max104Text" minOccurs="0"/>
 *         <element name="PmtAcctRef" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="PANAcctRg" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max19NumericText" minOccurs="0"/>
 *         <element name="CardCtryCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}ISO3NumericCountryCode" minOccurs="0"/>
 *         <element name="CardPdctTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="CardPdctSubTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="CardPrtflIdr" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
