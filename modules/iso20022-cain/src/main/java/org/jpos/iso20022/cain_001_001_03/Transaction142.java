...
/**
 * <p>Java class for Transaction142 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="Transaction142">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="TxTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}ISO8583TransactionTypeCode"/>
 *         <element name="TxSubTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="TxAttr" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TransactionAttribute2Code" minOccurs="0"/>
 *         <element name="OthrTxAttr" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="MsgRsn" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}ISO8583MessageReasonCode" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AltrnMsgRsn" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max256Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PreAuthstnTmLmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max6NumericText" minOccurs="0"/>
 *         <element name="AddtlSvc" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}AdditionalService2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AssoctdDataInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="AssoctdDataRef" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max70Text" minOccurs="0"/>
 *         <element name="AssoctdDataDstn" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="SpclPrgrmmQlfctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}SpecialProgrammeQualification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TransactionIdentification51"/>
 *         <element name="DsptData" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}DisputeData3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TxAmts" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TransactionAmounts2"/>
 *         <element name="AddtlAmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}AdditionalAmounts3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlFee" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}AdditionalFee2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="OrgnlAddtlFee" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}AdditionalFee2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="DpstDtls" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}DepositDetails2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FndsSvcs" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}FundingService2" minOccurs="0"/>
 *         <element name="AcctFr" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}AccountDetails3" minOccurs="0"/>
 *         <element name="AcctTo" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}AccountDetails3" minOccurs="0"/>
 *         <element name="TxDesc" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max1000Text" minOccurs="0"/>
