 ...
 *       <sequence>
 *         <element name="SeqNb" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35NumericText" minOccurs="0"/>
 *         <element name="Tckt" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Ticket2" minOccurs="0"/>
 *         <element name="Doc" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}DocumentReference1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PrcdrRef" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="TrnsprtTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TransportType1Code" minOccurs="0"/>
 *         <element name="OthrTrnsprtTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="CmmdtyCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max4Text" minOccurs="0"/>
 *         <element name="Crrier" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}CarrierIdentification1" minOccurs="0"/>
 *         <element name="RouteNb" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="SvcClss" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="Dprture" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}DepartureOrArrival1" minOccurs="0"/>
 *         <element name="Arrvl" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}DepartureOrArrival1" minOccurs="0"/>
 *         <element name="Drtn" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max4NumericText" minOccurs="0"/>
 *         <element name="StopOverInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="NonDrctRouteCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="FairBsisCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="InsrncInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="TripLegAmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}AmountDetails2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CdtRsnCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="PrcdrId" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="LltyPrgrmm" type="{urn:iso:std:iso:20022:tech:xsd:cain.001.001.03}LoyaltyProgramme2" minOccurs="0"/>
