 ...
 *       <sequence>
 *         <element name="PlanId" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}Max70Text" minOccurs="0"/>
 *         <element name="PlanOwnr" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}PlanOwner1Code" minOccurs="0"/>
 *         <element name="OthrPlanOwnr" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}Max35Text" minOccurs="0"/>
 *         <element name="InstlmtPmtTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}Max35Text" minOccurs="0"/>
 *         <element name="DfrrdInstlmtInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="PrdUnit" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}Frequency18Code" minOccurs="0"/>
 *         <element name="NbOfPrds" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}Number" minOccurs="0"/>
 *         <element name="IntrstRate" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}InterestRateDetails2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FrstPmtDt" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}ISODate" minOccurs="0"/>
 *         <element name="FrstAmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="NrmlPmtAmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="TtlNbOfPmts" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}Number" minOccurs="0"/>
 *         <element name="InstlmtCcy" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}ISO3NumericCurrencyCode" minOccurs="0"/>
 *         <element name="GracePrd" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}GracePeriod2" minOccurs="0"/>
 *         <element name="AmtDtls" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}InstalmentAmountDetails2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="GrdTtlAmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}ImpliedCurrencyAndAmount" minOccurs="0"/>
