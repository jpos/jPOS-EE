 ...
 *       <sequence>
 *         <element name="MrchntCtgyCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}ISO18245MerchantCategoryCode" minOccurs="0"/>
 *         <element name="MrchntCtgySpcfcData" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}Max35Text" minOccurs="0"/>
 *         <element name="FeeColltnInitr" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}FeeCollectionInitiator1Code" minOccurs="0"/>
 *         <element name="TxInitr" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}TransactionInitiator1Code" minOccurs="0"/>
 *         <element name="PrtlShipmntInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="DelydChrgsInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="NoShowInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="ReauthstnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="ReSubmissnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CardPrgrmmApld" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}CardProgrammeMode3" minOccurs="0"/>
 *         <element name="Jursdctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}Jurisdiction2" minOccurs="0"/>
 *         <element name="SttlmSvc" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}SettlementService4" minOccurs="0"/>
 *         <element name="Rcncltn" type="{urn:iso:std:iso:20022:tech:xsd:cain.002.001.03}Reconciliation3" minOccurs="0"/>
