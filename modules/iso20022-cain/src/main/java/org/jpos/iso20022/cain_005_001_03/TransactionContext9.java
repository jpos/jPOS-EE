 ...
 *       <sequence>
 *         <element name="MrchntCtgyCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}ISO18245MerchantCategoryCode" minOccurs="0"/>
 *         <element name="MrchntCtgySpcfcData" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}Max35Text" minOccurs="0"/>
 *         <element name="DfrrdDlvryInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="PrtlShipmntInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="DelydChrgsInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="NoShowInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="ReauthstnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="ReSubmissnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="TxInitr" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}TransactionInitiator1Code" minOccurs="0"/>
 *         <element name="AuthntcnOutgInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CardPrgrmm" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}CardProgramme2" minOccurs="0"/>
 *         <element name="Jursdctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}Jurisdiction2" minOccurs="0"/>
 *         <element name="SttlmSvc" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}SettlementService3" minOccurs="0"/>
 *         <element name="Rcncltn" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}Reconciliation3" minOccurs="0"/>
 *         <element name="CaptrDt" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}ISODate" minOccurs="0"/>
 *         <element name="DtAntcptd" type="{urn:iso:std:iso:20022:tech:xsd:cain.005.001.03}ISODate" minOccurs="0"/>
