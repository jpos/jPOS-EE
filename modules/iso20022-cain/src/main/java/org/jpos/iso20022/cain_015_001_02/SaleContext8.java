 ...
 *       <sequence>
 *         <element name="SaleId" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}Max35Text" minOccurs="0"/>
 *         <element name="SaleRefId" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}Max35Text" minOccurs="0"/>
 *         <element name="SaleRefNb" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}Max35Text" minOccurs="0"/>
 *         <element name="GoodsAndSvcsTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}GoodsAndServices1Code" minOccurs="0"/>
 *         <element name="GoodAndSvcsSubTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}GoodsAndServicesSubType1Code" minOccurs="0"/>
 *         <element name="GoodAndSvcsOthrSubTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}Max35Text" minOccurs="0"/>
 *         <element name="GoodAndSvcDlvryChanl" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}GoodAndServiceDeliveryChannel1Code" minOccurs="0"/>
 *         <element name="OthrGoodAndSvcDlvryChanl" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}Max35Text" minOccurs="0"/>
 *         <element name="GoodAndSvcDlvrySchdl" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}GoodAndServiceDeliverySchedule1Code" minOccurs="0"/>
 *         <element name="OthrGoodAndSvcDlvrySchdl" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}Max35Text" minOccurs="0"/>
 *         <element name="SpltPmtInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="RctReqInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="RctTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}ReceiptType1Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="RctDstn" type="{urn:iso:std:iso:20022:tech:xsd:cain.015.001.02}Max70Text" minOccurs="0"/>
