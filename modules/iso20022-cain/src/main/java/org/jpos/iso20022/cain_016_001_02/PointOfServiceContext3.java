 ...
 *       <sequence>
 *         <element name="CardPres" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CrdhldrPres" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CrdhldrActvtd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="TrnspndrInittd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="AttnddInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="UattnddLvlCtgy" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}Max35NumericText" minOccurs="0"/>
 *         <element name="EComrcInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="EComrcData" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}ECommerceData1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="MOTOCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}MOTO1Code" minOccurs="0"/>
 *         <element name="TrnstInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="PrtlApprvlSpprtd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="DelydAuthstnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="SctyChrtcs" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}SecurityCharacteristics1Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="OthrSctyChrtcs" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}Max35Text" minOccurs="0"/>
 *         <element name="CardDataNtryMd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}CardDataReading10Code"/>
 *         <element name="OthrCardDataNtryMd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}Max35Text" minOccurs="0"/>
 *         <element name="QRCdPresntmntMd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}QRCodePresentmentMode1Code" minOccurs="0"/>
 *         <element name="OthrQRCdPresntmntMd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}Max35Text" minOccurs="0"/>
 *         <element name="TempScrCardDataReusd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="StorgLctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}Max35Text" minOccurs="0"/>
 *         <element name="SpclConds" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}SpecialConditions1" maxOccurs="unbounded" minOccurs="0"/>
