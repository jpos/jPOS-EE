 ...
 *       <sequence>
 *         <element name="MrchntCtgyCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}ISO18245MerchantCategoryCode"/>
 *         <element name="MrchntCtgySpcfcData" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}Max35Text" minOccurs="0"/>
 *         <element name="CstmrCnsnt" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="PINPadInprtv" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="PINNtryBpssInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="ICCFllbckInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="ICCFllbckRsnCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}ICCFallbackReason1Code" minOccurs="0"/>
 *         <element name="OthrICCFllbckRsnCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}Max35Text" minOccurs="0"/>
 *         <element name="MgntcStrpFllbckInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="LatePresntmntInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="FnlAuthstnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="DfrrdDlvryInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="PrtlShipmntInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="DelydChrgsInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="NoShowInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="ReauthstnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="ReSubmissnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="TxInitr" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TransactionInitiator1Code" minOccurs="0"/>
 *         <element name="AuthntcnOutgInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CardPrgrmm" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}CardProgramme2" minOccurs="0"/>
 *         <element name="Jursdctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}Jurisdiction2" minOccurs="0"/>
 *         <element name="SttlmSvc" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}SettlementService3" minOccurs="0"/>
 *         <element name="Rcncltn" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}Reconciliation3" minOccurs="0"/>
 *         <element name="XchgRateInf" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}ExchangeRateInformation2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CaptrDt" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}ISODate" minOccurs="0"/>
 *         <element name="DtAntcptd" type="{urn:iso:std:iso:20022:tech:xsd:cain.016.001.02}ISODate" minOccurs="0"/>
