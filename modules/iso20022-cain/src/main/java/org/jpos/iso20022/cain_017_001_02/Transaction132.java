...
/**
 * <p>Java class for Transaction132 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="Transaction132">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="TxTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}ISO8583TransactionTypeCode"/>
 *         <element name="TxSubTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}Max35Text" minOccurs="0"/>
 *         <element name="AddtlSvc" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}AdditionalService2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SpclPrgrmmQlfctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}SpecialProgrammeQualification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}TransactionIdentification18"/>
 *         <element name="RcncltnAmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}Amount15" minOccurs="0"/>
 *         <element name="AddtlAmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}AdditionalAmounts3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlFee" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}AdditionalFee2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AcctBal" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}AccountBalance2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AcctStmtData" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}AccountStatementData2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AcctFr" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}AccountDetails3" minOccurs="0"/>
 *         <element name="TxDesc" type="{urn:iso:std:iso:20022:tech:xsd:cain.017.001.02}Max1000Text" minOccurs="0"/>
