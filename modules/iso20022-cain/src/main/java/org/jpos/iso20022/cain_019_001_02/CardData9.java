...
/**
 * <p>Java class for CardData9 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="CardData9">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="PAN" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}Max19NumericText" minOccurs="0"/>
 *         <element name="PrtctdPANInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CardSeqNb" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}Min2Max3NumericText" minOccurs="0"/>
 *         <element name="FctvDt" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}ISOYearMonth" minOccurs="0"/>
 *         <element name="XpryDt" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}ISOYearMonth" minOccurs="0"/>
 *         <element name="Trck3" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}Max104Text" minOccurs="0"/>
 *         <element name="PmtAcctRef" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}Max35Text" minOccurs="0"/>
 *         <element name="PANAcctRg" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}Max19NumericText" minOccurs="0"/>
 *         <element name="PANFourLastDgts" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}Max4NumericText" minOccurs="0"/>
 *         <element name="CardCtryCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}ISO3NumericCountryCode" minOccurs="0"/>
 *         <element name="CardCcyCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}ISO3NumericCurrencyCode" minOccurs="0"/>
 *         <element name="CardPdctTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}Max35Text" minOccurs="0"/>
 *         <element name="CardPdctSubTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}Max35Text" minOccurs="0"/>
 *         <element name="CardPrtflIdr" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}Max35Text" minOccurs="0"/>
 *         <element name="AddtlCardData" type="{urn:iso:std:iso:20022:tech:xsd:cain.019.001.02}AdditionalData1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class CardData9 {
     ...
     *     
     */
    public void setPANFourLastDgts(String value) {
