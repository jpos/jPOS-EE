...
/**
 * <p>Java class for Header67 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="Header67">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="MsgFctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}MessageFunction45Code"/>
 *         <element name="PrtcolVrsn" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}Max2048Text"/>
 *         <element name="XchgId" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}Max35Text" minOccurs="0"/>
 *         <element name="ReTrnsmssnCntr" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}Max3NumericText" minOccurs="0"/>
 *         <element name="CreDtTm" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}ISODateTime"/>
 *         <element name="BtchMgmtInf" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}BatchManagementInformation1" minOccurs="0"/>
 *         <element name="InitgPty" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}GenericIdentification183"/>
 *         <element name="RcptPty" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}GenericIdentification183" minOccurs="0"/>
 *         <element name="TracData" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}AdditionalData1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Tracblt" type="{urn:iso:std:iso:20022:tech:xsd:cain.021.001.02}Traceability9" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class Header67 {
     ...
     *     
     */
    public void setMsgFctn(MessageFunction45Code value) {
        this.msgFctn = value;
    }
