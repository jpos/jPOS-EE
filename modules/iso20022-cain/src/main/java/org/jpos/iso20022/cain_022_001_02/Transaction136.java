 ...
 *       <sequence>
 *         <element name="MsgRsn" type="{urn:iso:std:iso:20022:tech:xsd:cain.022.001.02}ISO8583MessageReasonCode" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AltrnMsgRsn" type="{urn:iso:std:iso:20022:tech:xsd:cain.022.001.02}Max256Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SpclPrgrmmQlfctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.022.001.02}SpecialProgrammeQualification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:cain.022.001.02}TransactionIdentification18"/>
 *         <element name="DsptData" type="{urn:iso:std:iso:20022:tech:xsd:cain.022.001.02}DisputeData3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="RtrvlFlfmtInstrs" type="{urn:iso:std:iso:20022:tech:xsd:cain.022.001.02}RetrievalFulfilmentInstructions2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlFee" type="{urn:iso:std:iso:20022:tech:xsd:cain.022.001.02}AdditionalFee2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TxDesc" type="{urn:iso:std:iso:20022:tech:xsd:cain.022.001.02}Max1000Text" minOccurs="0"/>
