 ...
 *       <sequence>
 *         <element name="MsgClss" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}MessageClass1Code" minOccurs="0"/>
 *         <element name="MsgFctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}MessageFunction16Code" minOccurs="0"/>
 *         <element name="TxTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}ISO8583TransactionTypeCode" minOccurs="0"/>
 *         <element name="AcqrrId" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Max11NumericText" minOccurs="0"/>
 *         <element name="SndrId" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Max11NumericText" minOccurs="0"/>
 *         <element name="LclDt" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}ISODate" minOccurs="0"/>
 *         <element name="LclTm" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}ISOTime" minOccurs="0"/>
 *         <element name="TmZone" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Max70Text" minOccurs="0"/>
 *         <element name="TxRef" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Max35Text" minOccurs="0"/>
 *         <element name="TrnsmssnDtTm" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}ISODateTime" minOccurs="0"/>
 *         <element name="SysTracAudtNb" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Max12NumericText" minOccurs="0"/>
 *         <element name="RtrvlRefNb" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Exact12Text" minOccurs="0"/>
 *         <element name="LifeCyclSpprt" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}LifeCycleSupport1Code" minOccurs="0"/>
 *         <element name="LifeCyclTracIdData" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}TransactionLifeCycleIdentification1" minOccurs="0"/>
 *         <element name="LifeCyclTracIdMssng" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Max70Text" minOccurs="0"/>
 *         <element name="AcqrrRefData" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Max140Text" minOccurs="0"/>
 *         <element name="AcqrrRefNb" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Max23NumericText" minOccurs="0"/>
 *         <element name="CardIssrRefData" type="{urn:iso:std:iso:20022:tech:xsd:cain.023.001.02}Max1000Text" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
