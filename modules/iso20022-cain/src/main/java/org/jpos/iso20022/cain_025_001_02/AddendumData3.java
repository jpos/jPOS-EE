 ...
 *       <sequence>
 *         <element name="PurchsIdrTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}PurchaseIdentifierType1Code" minOccurs="0"/>
 *         <element name="OthrPurchsIdrTp" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}Max35Text" minOccurs="0"/>
 *         <element name="PurchsIdr" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}Max99Text" minOccurs="0"/>
 *         <element name="AddtlAccptrData" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}AdditionalAcceptorData1" minOccurs="0"/>
 *         <element name="Cstmr" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}Customer4" minOccurs="0"/>
 *         <element name="Sale" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}Sale2" minOccurs="0"/>
 *         <element name="Fleet" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}FleetData4" minOccurs="0"/>
 *         <element name="Invc" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}Invoice2" minOccurs="0"/>
 *         <element name="TrvlAgcy" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}TravelAgency3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PssngrTrnsprt" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}PassengerTransport2" minOccurs="0"/>
 *         <element name="VhclRntl" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}VehicleRentalService2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Ldgg" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}Lodging3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ShppgData" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}ShippingData2" minOccurs="0"/>
 *         <element name="TelecomSvcs" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}TelecomServices2" minOccurs="0"/>
 *         <element name="TempSvcs" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}TemporaryServices2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Instlmt" type="{urn:iso:std:iso:20022:tech:xsd:cain.025.001.02}Instalment4" minOccurs="0"/>
