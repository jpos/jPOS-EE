 ...
 *       <sequence>
 *         <element name="Id" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max35Text"/>
 *         <element name="Assgnr" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max35Text" minOccurs="0"/>
 *         <element name="Ctry" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}ISO3NumericCountryCode" minOccurs="0"/>
 *         <element name="ShrtNm" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max35Text" minOccurs="0"/>
 *         <element name="LglCorpNm" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max99Text" minOccurs="0"/>
 *         <element name="AddtlId" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}AdditionalData1" minOccurs="0"/>
 *         <element name="NmAndLctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max99Text"/>
 *         <element name="Adr" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Address2" minOccurs="0"/>
 *         <element name="AddtlAdrInf" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max256Text" minOccurs="0"/>
 *         <element name="GeogcLctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}GeographicPointInDecimalDegrees" minOccurs="0"/>
 *         <element name="Email" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max256Text" minOccurs="0"/>
 *         <element name="URLAdr" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max256Text" minOccurs="0"/>
 *         <element name="PhneNb" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max35Text" minOccurs="0"/>
 *         <element name="CstmrSvc" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max35Text" minOccurs="0"/>
 *         <element name="AddtlCtctInf" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max256Text" minOccurs="0"/>
 *         <element name="TaxRegnId" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}Max35Text" minOccurs="0"/>
 *         <element name="AddtlData" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}AdditionalData1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="LclData" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}LocalData4" minOccurs="0"/>
 *         <element name="SpnsrdMrchnt" type="{urn:iso:std:iso:20022:tech:xsd:cain.026.001.02}SponsoredMerchant2" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
