...
/**
 * <p>Java class for FundEstimatedCashForecastReportV04 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="FundEstimatedCashForecastReportV04">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="MsgId" type="{urn:swift:xsd:camt.040.001.04}MessageIdentification1"/>
 *         <element name="PoolRef" type="{urn:swift:xsd:camt.040.001.04}AdditionalReference3" minOccurs="0"/>
 *         <element name="PrvsRef" type="{urn:swift:xsd:camt.040.001.04}AdditionalReference3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="RltdRef" type="{urn:swift:xsd:camt.040.001.04}AdditionalReference3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="MsgPgntn" type="{urn:swift:xsd:camt.040.001.04}Pagination"/>
 *         <element name="FndOrSubFndDtls" type="{urn:swift:xsd:camt.040.001.04}Fund1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="EstmtdFndCshFcstDtls" type="{urn:swift:xsd:camt.040.001.04}EstimatedFundCashForecast6" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CnsltdNetCshFcst" type="{urn:swift:xsd:camt.040.001.04}NetCashForecast3" minOccurs="0"/>
 *         <element name="Xtnsn" type="{urn:swift:xsd:camt.040.001.04}Extension1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
