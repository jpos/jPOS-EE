 ...
 *       <sequence>
 *         <choice>
 *           <element name="ISIN" type="{urn:swift:xsd:camt.040.001.04}ISINIdentifier"/>
 *           <element name="SEDOL" type="{urn:swift:xsd:camt.040.001.04}SEDOLIdentifier"/>
 *           <element name="CUSIP" type="{urn:swift:xsd:camt.040.001.04}CUSIPIdentifier"/>
 *           <element name="RIC" type="{urn:swift:xsd:camt.040.001.04}RICIdentifier"/>
 *           <element name="TckrSymb" type="{urn:swift:xsd:camt.040.001.04}TickerIdentifier"/>
 *           <element name="Blmbrg" type="{urn:swift:xsd:camt.040.001.04}BloombergIdentifier"/>
 *           <element name="CTA" type="{urn:swift:xsd:camt.040.001.04}ConsolidatedTapeAssociationIdentifier"/>
 *           <element name="QUICK" type="{urn:swift:xsd:camt.040.001.04}QUICKIdentifier"/>
 *           <element name="Wrtppr" type="{urn:swift:xsd:camt.040.001.04}WertpapierIdentifier"/>
 *           <element name="Dtch" type="{urn:swift:xsd:camt.040.001.04}DutchIdentifier"/>
 *           <element name="Vlrn" type="{urn:swift:xsd:camt.040.001.04}ValorenIdentifier"/>
 *           <element name="SCVM" type="{urn:swift:xsd:camt.040.001.04}SicovamIdentifier"/>
 *           <element name="Belgn" type="{urn:swift:xsd:camt.040.001.04}BelgianIdentifier"/>
 *           <element name="Cmon" type="{urn:swift:xsd:camt.040.001.04}EuroclearClearstreamIdentifier"/>
 *           <element name="OthrPrtryId" type="{urn:swift:xsd:camt.040.001.04}AlternateSecurityIdentification1"/>
 *         </choice>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
