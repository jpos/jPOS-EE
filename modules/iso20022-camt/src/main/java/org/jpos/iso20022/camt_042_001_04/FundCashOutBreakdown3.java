 ...
 *       <sequence>
 *         <element name="Amt" type="{urn:swift:xsd:camt.042.001.04}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="UnitsNb" type="{urn:swift:xsd:camt.042.001.04}FinancialInstrumentQuantity1" minOccurs="0"/>
 *         <element name="NewAmtInd" type="{urn:swift:xsd:camt.042.001.04}YesNoIndicator" minOccurs="0"/>
 *         <element name="InvstmtFndTxOutTp" type="{urn:swift:xsd:camt.042.001.04}InvestmentFundTransactionOutType1Choice"/>
 *         <element name="OrgnlOrdrQtyTp" type="{urn:swift:xsd:camt.042.001.04}QuantityType1Choice"/>
 *         <element name="ChrgDtls" type="{urn:swift:xsd:camt.042.001.04}Charge26" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ComssnDtls" type="{urn:swift:xsd:camt.042.001.04}Commission21" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SttlmCcy" type="{urn:swift:xsd:camt.042.001.04}ActiveCurrencyCode" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
