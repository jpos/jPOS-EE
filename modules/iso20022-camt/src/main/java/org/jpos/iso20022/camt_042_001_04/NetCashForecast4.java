 ...
 *         <element name="NetAmt" type="{urn:swift:xsd:camt.042.001.04}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="NetUnitsNb" type="{urn:swift:xsd:camt.042.001.04}FinancialInstrumentQuantity1" minOccurs="0"/>
 *         <element name="FlowDrctn" type="{urn:swift:xsd:camt.042.001.04}FlowDirectionType1Code"/>
