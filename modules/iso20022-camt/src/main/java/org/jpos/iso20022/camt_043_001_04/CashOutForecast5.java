 ...
 *       <sequence>
 *         <element name="CshSttlmDt" type="{urn:swift:xsd:camt.043.001.04}ISODate"/>
 *         <element name="SubTtlAmt" type="{urn:swift:xsd:camt.043.001.04}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="SubTtlUnitsNb" type="{urn:swift:xsd:camt.043.001.04}FinancialInstrumentQuantity1" minOccurs="0"/>
 *         <element name="XcptnlCshFlowInd" type="{urn:swift:xsd:camt.043.001.04}YesNoIndicator" minOccurs="0"/>
 *         <element name="CshOutBrkdwnDtls" type="{urn:swift:xsd:camt.043.001.04}FundCashOutBreakdown3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlBal" type="{urn:swift:xsd:camt.043.001.04}FundBalance1" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
