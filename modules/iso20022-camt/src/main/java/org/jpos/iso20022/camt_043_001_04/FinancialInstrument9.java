 ...
 *       <sequence>
 *         <element name="Id" type="{urn:swift:xsd:camt.043.001.04}SecurityIdentification3Choice"/>
 *         <element name="Nm" type="{urn:swift:xsd:camt.043.001.04}Max350Text" minOccurs="0"/>
 *         <element name="SplmtryId" type="{urn:swift:xsd:camt.043.001.04}Max35Text" minOccurs="0"/>
 *         <element name="ReqdNAVCcy" type="{urn:swift:xsd:camt.043.001.04}ActiveOrHistoricCurrencyCode" minOccurs="0"/>
 *         <element name="ClssTp" type="{urn:swift:xsd:camt.043.001.04}Max35Text" minOccurs="0"/>
 *         <element name="SctiesForm" type="{urn:swift:xsd:camt.043.001.04}FormOfSecurity1Code" minOccurs="0"/>
 *         <element name="DstrbtnPlcy" type="{urn:swift:xsd:camt.043.001.04}DistributionPolicy1Code" minOccurs="0"/>
 *         <element name="DualFndInd" type="{urn:swift:xsd:camt.043.001.04}YesNoIndicator"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
