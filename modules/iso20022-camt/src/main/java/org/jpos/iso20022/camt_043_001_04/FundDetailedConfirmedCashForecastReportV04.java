...
/**
 * <p>Java class for FundDetailedConfirmedCashForecastReportV04 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="FundDetailedConfirmedCashForecastReportV04">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="MsgId" type="{urn:swift:xsd:camt.043.001.04}MessageIdentification1"/>
 *         <element name="PoolRef" type="{urn:swift:xsd:camt.043.001.04}AdditionalReference3" minOccurs="0"/>
 *         <element name="PrvsRef" type="{urn:swift:xsd:camt.043.001.04}AdditionalReference3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="RltdRef" type="{urn:swift:xsd:camt.043.001.04}AdditionalReference3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="MsgPgntn" type="{urn:swift:xsd:camt.043.001.04}Pagination"/>
 *         <element name="FndOrSubFndDtls" type="{urn:swift:xsd:camt.043.001.04}Fund4" minOccurs="0"/>
 *         <element name="FndCshFcstDtls" type="{urn:swift:xsd:camt.043.001.04}FundCashForecast6" maxOccurs="unbounded"/>
 *         <element name="CnsltdNetCshFcst" type="{urn:swift:xsd:camt.043.001.04}NetCashForecast3" minOccurs="0"/>
 *         <element name="Xtnsn" type="{urn:swift:xsd:camt.043.001.04}Extension1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
