 ...
 *       <sequence>
 *         <element name="AdrTp" type="{urn:swift:xsd:camt.043.001.04}AddressType2Code" minOccurs="0"/>
 *         <element name="AdrLine" type="{urn:swift:xsd:camt.043.001.04}Max70Text" maxOccurs="5" minOccurs="0"/>
 *         <element name="StrtNm" type="{urn:swift:xsd:camt.043.001.04}Max70Text" minOccurs="0"/>
 *         <element name="BldgNb" type="{urn:swift:xsd:camt.043.001.04}Max16Text" minOccurs="0"/>
 *         <element name="PstCd" type="{urn:swift:xsd:camt.043.001.04}Max16Text" minOccurs="0"/>
 *         <element name="TwnNm" type="{urn:swift:xsd:camt.043.001.04}Max35Text" minOccurs="0"/>
 *         <element name="CtrySubDvsn" type="{urn:swift:xsd:camt.043.001.04}Max35Text" minOccurs="0"/>
 *         <element name="Ctry" type="{urn:swift:xsd:camt.043.001.04}CountryCode"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
