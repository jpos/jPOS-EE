 ...
 *       <sequence>
 *         <element name="Nm" type="{urn:swift:xsd:camt.044.001.03}Max350Text" minOccurs="0"/>
 *         <element name="LglNttyIdr" type="{urn:swift:xsd:camt.044.001.03}LEIIdentifier" minOccurs="0"/>
 *         <element name="Id" type="{urn:swift:xsd:camt.044.001.03}OtherIdentification4" minOccurs="0"/>
 *         <element name="Ccy" type="{urn:swift:xsd:camt.044.001.03}ActiveOrHistoricCurrencyCode" minOccurs="0"/>
 *         <element name="TradDtTm" type="{urn:swift:xsd:camt.044.001.03}DateAndDateTimeChoice" minOccurs="0"/>
 *         <element name="PrvsTradDtTm" type="{urn:swift:xsd:camt.044.001.03}DateAndDateTimeChoice" minOccurs="0"/>
 *         <element name="TtlNAV" type="{urn:swift:xsd:camt.044.001.03}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="PrvsTtlNAV" type="{urn:swift:xsd:camt.044.001.03}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 ...
 *         <element name="PctgOfFndTtlNAV" type="{urn:swift:xsd:camt.044.001.03}PercentageRate" minOccurs="0"/>
 *         <element name="CshInFcstDtls" type="{urn:swift:xsd:camt.044.001.03}CashInOutForecast7" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CshOutFcstDtls" type="{urn:swift:xsd:camt.044.001.03}CashInOutForecast7" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="NetCshFcstDtls" type="{urn:swift:xsd:camt.044.001.03}NetCashForecast5" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
