 ...
 *       <sequence>
 *         <element name="Id" type="{urn:swift:xsd:camt.045.001.03}Max35Text"/>
 *         <element name="TradDtTm" type="{urn:swift:xsd:camt.045.001.03}DateAndDateTimeChoice"/>
 *         <element name="PrvsTradDtTm" type="{urn:swift:xsd:camt.045.001.03}DateAndDateTimeChoice" minOccurs="0"/>
 *         <element name="FinInstrmDtls" type="{urn:swift:xsd:camt.045.001.03}FinancialInstrument9"/>
 *         <element name="TtlNAV" type="{urn:swift:xsd:camt.045.001.03}ActiveOrHistoricCurrencyAndAmount" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PrvsTtlNAV" type="{urn:swift:xsd:camt.045.001.03}ActiveOrHistoricCurrencyAndAmount" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="TtlNAVChngRate" type="{urn:swift:xsd:camt.045.001.03}PercentageRate" minOccurs="0"/>
 *         <element name="InvstmtCcy" type="{urn:swift:xsd:camt.045.001.03}ActiveOrHistoricCurrencyCode" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CcySts" type="{urn:swift:xsd:camt.045.001.03}CurrencyDesignation1" minOccurs="0"/>
 *         <element name="XcptnlNetCshFlowInd" type="{urn:swift:xsd:camt.045.001.03}YesNoIndicator"/>
 *         <element name="Pric" type="{urn:swift:xsd:camt.045.001.03}UnitPrice19" minOccurs="0"/>
 *         <element name="FXRate" type="{urn:swift:xsd:camt.045.001.03}ForeignExchangeTerms19" minOccurs="0"/>
 *         <element name="PctgOfShrClssTtlNAV" type="{urn:swift:xsd:camt.045.001.03}PercentageRate" minOccurs="0"/>
 *         <element name="BrkdwnByPty" type="{urn:swift:xsd:camt.045.001.03}BreakdownByParty3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="BrkdwnByCtry" type="{urn:swift:xsd:camt.045.001.03}BreakdownByCountry2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="BrkdwnByCcy" type="{urn:swift:xsd:camt.045.001.03}BreakdownByCurrency2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="BrkdwnByUsrDfndParam" type="{urn:swift:xsd:camt.045.001.03}BreakdownByUserDefinedParameter3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="NetCshFcstDtls" type="{urn:swift:xsd:camt.045.001.03}NetCashForecast4" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
