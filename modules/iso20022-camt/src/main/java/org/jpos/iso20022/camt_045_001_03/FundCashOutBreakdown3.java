...
/**
 * <p>Java class for FundCashOutBreakdown3 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="FundCashOutBreakdown3">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="Amt" type="{urn:swift:xsd:camt.045.001.03}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="UnitsNb" type="{urn:swift:xsd:camt.045.001.03}FinancialInstrumentQuantity1" minOccurs="0"/>
 *         <element name="NewAmtInd" type="{urn:swift:xsd:camt.045.001.03}YesNoIndicator" minOccurs="0"/>
 *         <element name="InvstmtFndTxOutTp" type="{urn:swift:xsd:camt.045.001.03}InvestmentFundTransactionOutType1Choice"/>
 *         <element name="OrgnlOrdrQtyTp" type="{urn:swift:xsd:camt.045.001.03}QuantityType1Choice"/>
 *         <element name="ChrgDtls" type="{urn:swift:xsd:camt.045.001.03}Charge26" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ComssnDtls" type="{urn:swift:xsd:camt.045.001.03}Commission21" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SttlmCcy" type="{urn:swift:xsd:camt.045.001.03}ActiveCurrencyCode" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class FundCashOutBreakdown3 {
     ...
     *     
     */
    public void setInvstmtFndTxOutTp(InvestmentFundTransactionOutType1Choice value) {
