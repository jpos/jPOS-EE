 ...
 *       <sequence>
 *         <element name="Refs" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TransactionReferences6" minOccurs="0"/>
 ...
 *         <element name="AmtDtls" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}AmountAndCurrencyExchange4" minOccurs="0"/>
 ...
 *         <element name="BkTxCd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}BankTransactionCodeStructure4" minOccurs="0"/>
 *         <element name="Chrgs" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}Charges6" minOccurs="0"/>
 *         <element name="Intrst" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TransactionInterest4" minOccurs="0"/>
 *         <element name="RltdPties" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TransactionParties9" minOccurs="0"/>
 *         <element name="RltdAgts" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TransactionAgents5" minOccurs="0"/>
 *         <element name="LclInstrm" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}LocalInstrument2Choice" minOccurs="0"/>
 *         <element name="PmtTpInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}PaymentTypeInformation27" minOccurs="0"/>
 *         <element name="Purp" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}Purpose2Choice" minOccurs="0"/>
 *         <element name="RltdRmtInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}RemittanceLocation7" maxOccurs="10" minOccurs="0"/>
 *         <element name="RmtInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}RemittanceInformation21" minOccurs="0"/>
 *         <element name="RltdDts" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TransactionDates3" minOccurs="0"/>
 *         <element name="RltdPric" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TransactionPrice4Choice" minOccurs="0"/>
 *         <element name="RltdQties" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TransactionQuantities3Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FinInstrmId" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}SecurityIdentification19" minOccurs="0"/>
 *         <element name="Tax" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TaxInformation10" minOccurs="0"/>
 *         <element name="RtrInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}PaymentReturnReason5" minOccurs="0"/>
 *         <element name="CorpActn" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}CorporateAction9" minOccurs="0"/>
 *         <element name="SfkpgAcct" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}SecuritiesAccount19" minOccurs="0"/>
 *         <element name="CshDpst" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}CashDeposit1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CardTx" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}CardTransaction18" minOccurs="0"/>
 *         <element name="AddtlTxInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}Max500Text" minOccurs="0"/>
 *         <element name="SplmtryData" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}SupplementaryData1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
