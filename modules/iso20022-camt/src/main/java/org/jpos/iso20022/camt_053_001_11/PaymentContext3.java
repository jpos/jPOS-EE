 ...
 *       <sequence>
 *         <element name="CardPres" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CrdhldrPres" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="OnLineCntxt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="AttndncCntxt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}AttendanceContext1Code" minOccurs="0"/>
 *         <element name="TxEnvt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TransactionEnvironment1Code" minOccurs="0"/>
 *         <element name="TxChanl" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TransactionChannel1Code" minOccurs="0"/>
 *         <element name="AttndntMsgCpbl" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="AttndntLang" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}ISO2ALanguageCode" minOccurs="0"/>
 *         <element name="CardDataNtryMd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}CardDataReading1Code"/>
 *         <element name="FllbckInd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="AuthntcnMtd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.11}CardholderAuthentication2" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
