 ...
 *       <sequence>
 *         <element name="Amt" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}Amount2Choice"/>
 *         <element name="CdtDbtInd" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}CreditDebitCode"/>
 *         <element name="Ccy" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}StandingOrderType1Choice" minOccurs="0"/>
 *         <element name="AssoctdPoolAcct" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}AccountIdentification4Choice" minOccurs="0"/>
 *         <element name="Ref" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}Max35Text" minOccurs="0"/>
 *         <element name="Frqcy" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}Frequency2Code" minOccurs="0"/>
 *         <element name="VldtyPrd" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}DatePeriod3" minOccurs="0"/>
 *         <element name="SysMmb" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="RspnsblPty" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="LkSetId" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}Max35Text" minOccurs="0"/>
 *         <element name="LkSetOrdrId" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}Max35Text" minOccurs="0"/>
 *         <element name="LkSetOrdrSeq" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}Number" minOccurs="0"/>
 *         <element name="ExctnTp" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}ExecutionType1Choice" minOccurs="0"/>
 *         <element name="Cdtr" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="CdtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}CashAccount40" minOccurs="0"/>
 *         <element name="Dbtr" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="DbtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}CashAccount40" minOccurs="0"/>
 *         <element name="TtlsPerStgOrdr" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}StandingOrderTotalAmount1" minOccurs="0"/>
 *         <element name="ZeroSweepInd" type="{urn:iso:std:iso:20022:tech:xsd:camt.070.001.05}TrueFalseIndicator" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
