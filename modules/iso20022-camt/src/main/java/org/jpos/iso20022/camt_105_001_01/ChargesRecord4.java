...
/**
 * <p>Java class for ChargesRecord4 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="ChargesRecord4">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="ChrgsRcrdId" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}Max35Text" minOccurs="0"/>
 *         <element name="UndrlygTx" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}TransactionReferences7" maxOccurs="unbounded"/>
 *         <element name="Amt" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}ActiveCurrencyAndAmount"/>
 *         <element name="CdtDbtInd" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}CreditDebitCode" minOccurs="0"/>
 *         <element name="ValDt" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}DateAndDateTime2Choice" minOccurs="0"/>
 *         <element name="DbtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="DbtrAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}CashAccount40" minOccurs="0"/>
 *         <element name="ChrgsAcct" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}CashAccount40"/>
 *         <element name="ChrgsAcctOwnr" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}ChargeType3Choice" minOccurs="0"/>
 *         <element name="InstrForInstdAgt" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}InstructionForInstructedAgent1" minOccurs="0"/>
 *         <element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.105.001.01}Max140Text" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ChargesRecord4 {
     ...
     *     
     */
    public void setChrgsAcctOwnr(BranchAndFinancialInstitutionIdentification6 value) {
