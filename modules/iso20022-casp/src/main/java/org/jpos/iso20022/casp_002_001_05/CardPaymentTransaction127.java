 ...
 *       <sequence>
 *         <element name="TxCaptr" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="TxTp" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}CardPaymentServiceType5Code"/>
 *         <element name="AddtlSvc" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}CardPaymentServiceType9Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SvcAttr" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}CardPaymentServiceType14Code" minOccurs="0"/>
 *         <element name="LastTxFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="MrchntCtgyCd" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Min3Max4Text" minOccurs="0"/>
 *         <element name="SaleRefId" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max35Text" minOccurs="0"/>
 *         <element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}TransactionIdentifier1"/>
 *         <element name="OrgnlTx" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}CardPaymentTransaction126" minOccurs="0"/>
 *         <element name="RcncltnId" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max35Text" minOccurs="0"/>
 *         <element name="IssrRefData" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max140Text" minOccurs="0"/>
 *         <element name="IssrCITId" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max140Text" minOccurs="0"/>
 *         <element name="MrchntCITId" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max140Text" minOccurs="0"/>
 *         <element name="TxDtls" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}CardPaymentTransactionDetails52"/>
 *         <element name="AuthstnRslt" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}AuthorisationResult18" minOccurs="0"/>
 *         <element name="MrchntRefData" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max70Text" minOccurs="0"/>
 *         <element name="CstmrOrdr" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}CustomerOrder1" minOccurs="0"/>
 *         <element name="CstmrTkn" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}CardPaymentToken5" minOccurs="0"/>
 *         <element name="CstmrCnsnt" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CardPrgrmmPropsd" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CardPrgrmmApld" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max35Text" minOccurs="0"/>
 *         <element name="SaleToPOIData" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max70Text" minOccurs="0"/>
 *         <element name="SaleToAcqrrData" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max70Text" minOccurs="0"/>
 *         <element name="SaleToIssrData" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max70Text" minOccurs="0"/>
 *         <element name="AddtlTxData" type="{urn:iso:std:iso:20022:tech:xsd:casp.002.001.05}Max70Text" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
