 ...
 *       <sequence>
 *         <element name="InstlmtPlan" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}InstalmentPlan1Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PlanId" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}Max35Text" minOccurs="0"/>
 *         <element name="PlanOwnr" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}PlanOwner1Code" minOccurs="0"/>
 *         <element name="SeqNb" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}Number" minOccurs="0"/>
 *         <element name="PrdUnit" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}Frequency3Code" minOccurs="0"/>
 *         <element name="InstlmtPrd" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}Number" minOccurs="0"/>
 *         <element name="TtlNbOfPmts" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}Number" minOccurs="0"/>
 *         <element name="FrstPmtDt" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}ISODate" minOccurs="0"/>
 *         <element name="TtlAmt" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}CurrencyAndAmount" minOccurs="0"/>
 *         <element name="FrstAmt" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="SbsqntAmt" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="LastAmt" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="Chrgs" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="DtldChrgs" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}InstalmentAmountDetails1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="IntrstRate" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}InterestRateDetails1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="GracePrd" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}GracePeriod1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PlanNtce" type="{urn:iso:std:iso:20022:tech:xsd:casp.010.001.05}ActionMessage10" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
