 ...
 *       <sequence>
 *         <element name="ItmId" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}Max35Text" minOccurs="0"/>
 *         <element name="PdctCd" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}Max70Text"/>
 *         <element name="AddtlPdctCd" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}Max70Text" minOccurs="0"/>
 *         <element name="UnitOfMeasr" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}UnitOfMeasure6Code" minOccurs="0"/>
 *         <element name="PdctQty" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}DecimalNumber" minOccurs="0"/>
 *         <element name="UnitPric" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="UnitPricSgn" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}PlusOrMinusIndicator" minOccurs="0"/>
 *         <element name="PdctAmt" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}ImpliedCurrencyAndAmount"/>
 *         <element name="PdctAmtSgn" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}PlusOrMinusIndicator" minOccurs="0"/>
 *         <element name="ValAddedTax" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         <element name="TaxTp" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}Max35Text" minOccurs="0"/>
 *         <element name="PdctDesc" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}Max140Text" minOccurs="0"/>
 *         <element name="DlvryLctn" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}Max10Text" minOccurs="0"/>
 *         <element name="DlvrySvc" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}AttendanceContext2Code" minOccurs="0"/>
 *         <element name="SaleChanl" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}Max70Text" minOccurs="0"/>
 *         <element name="AddtlPdctDesc" type="{urn:iso:std:iso:20022:tech:xsd:casp.015.001.05}Max256Text" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
