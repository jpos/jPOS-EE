 ...
 *       <sequence>
 *         <element name="Envt" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}CardPaymentEnvironment79" minOccurs="0"/>
 *         <element name="Cntxt" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}CardPaymentContext30" minOccurs="0"/>
 *         <element name="SvcCntt" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}RetailerService8Code"/>
 *         <element name="DispReq" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DeviceDisplayRequest5" minOccurs="0"/>
 *         <element name="InptReq" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DeviceInputRequest5" minOccurs="0"/>
 *         <element name="PrtReq" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DevicePrintRequest5" minOccurs="0"/>
 *         <element name="PlayRsrcReq" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DevicePlayResourceRequest1" minOccurs="0"/>
 *         <element name="ScrInptReq" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DeviceSecureInputRequest5" minOccurs="0"/>
 *         <element name="InitlstnCardRdrReq" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DeviceInitialisationCardReaderRequest5" minOccurs="0"/>
 *         <element name="CardRdrAPDUReq" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DeviceSendApplicationProtocolDataUnitCardReaderRequest1" minOccurs="0"/>
 *         <element name="PwrOffCardRdrReq" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DevicePoweroffCardReaderRequest5" minOccurs="0"/>
 *         <element name="TrnsmssnReq" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DeviceTransmitMessageRequest2" minOccurs="0"/>
 *         <element name="InptNtfctn" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}DeviceInputNotification5" minOccurs="0"/>
 *         <element name="SplmtryData" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}SupplementaryData1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
