 ...
 *       <sequence>
 *         <element name="DvcTp" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}SaleCapabilities2Code"/>
 *         <element name="InfQlfr" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}InformationQualify1Code"/>
 *         <element name="InptCmd" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}InputCommand1Code"/>
 *         <element name="NtfyCardInptFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}TrueFalseIndicator"/>
 *         <element name="MaxInptTm" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}Number" minOccurs="0"/>
 *         <element name="InptTxt" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}ActionMessage10" minOccurs="0"/>
 *         <element name="ImdtRspnFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="WaitUsrVldtnFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="BeepKeyFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="GblCrrctnFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="DsblCclFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="DsblCrrctFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="DsblVldFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="MenuBckFlg" type="{urn:iso:std:iso:20022:tech:xsd:casp.016.001.05}TrueFalseIndicator" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
