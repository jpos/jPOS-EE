 ...
 *         <element name="AcqrrId" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}GenericIdentification176" maxOccurs="unbounded"/>
 ...
 *         <element name="Hst" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}AcquirerHostConfiguration9" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="OnLineTx" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}AcquirerProtocolExchangeBehavior2" minOccurs="0"/>
 *         <element name="OffLineTx" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}AcquirerProtocolExchangeBehavior2" minOccurs="0"/>
 *         <element name="RcncltnXchg" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}ExchangeConfiguration9" minOccurs="0"/>
 *         <element name="RcncltnByAcqrr" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="TtlsPerCcy" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="SpltTtls" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="SpltTtlCrit" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}ReconciliationCriteria1Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CmpltnAdvcMndtd" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="AmtQlfrForRsvatn" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TypeOfAmount8Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="RcncltnErr" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="CardDataVrfctn" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="NtfyOffLineCxl" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="BtchTrfCntt" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}BatchTransactionType1Code" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FileTrfBtch" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="BtchDgtlSgntr" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 ...
 *         <element name="PrtctCardData" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator"/>
 *         <element name="PrvtCardData" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *         <element name="MndtrySctyTrlr" type="{urn:iso:std:iso:20022:tech:xsd:catm.003.001.12}TrueFalseIndicator" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
