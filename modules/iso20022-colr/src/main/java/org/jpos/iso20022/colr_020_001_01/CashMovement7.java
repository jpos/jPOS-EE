 ...
 *       <sequence>
 *         <element name="CshMvmnt" type="{urn:iso:std:iso:20022:tech:xsd:colr.020.001.01}CreditDebit3Code"/>
 *         <element name="CshAmt" type="{urn:iso:std:iso:20022:tech:xsd:colr.020.001.01}ActiveCurrencyAndAmount"/>
 *         <element name="CshAcct" type="{urn:iso:std:iso:20022:tech:xsd:colr.020.001.01}CashAccountIdentification5Choice" minOccurs="0"/>
 *         <element name="MvmntSts" type="{urn:iso:std:iso:20022:tech:xsd:colr.020.001.01}ProprietaryStatusAndReason6" minOccurs="0"/>
 *         <element name="CollMvmnt" type="{urn:iso:std:iso:20022:tech:xsd:colr.020.001.01}YesNoIndicator"/>
 *         <element name="CshMvmntApprvd" type="{urn:iso:std:iso:20022:tech:xsd:colr.020.001.01}YesNoIndicator" minOccurs="0"/>
 *         <element name="PosTp" type="{urn:iso:std:iso:20022:tech:xsd:colr.020.001.01}YesNoIndicator" minOccurs="0"/>
 *         <element name="ClntCshMvmntId" type="{urn:iso:std:iso:20022:tech:xsd:colr.020.001.01}Max35Text" minOccurs="0"/>
 *         <element name="TrptyAgtSvcPrvdrCshMvmntId" type="{urn:iso:std:iso:20022:tech:xsd:colr.020.001.01}Max35Text" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
