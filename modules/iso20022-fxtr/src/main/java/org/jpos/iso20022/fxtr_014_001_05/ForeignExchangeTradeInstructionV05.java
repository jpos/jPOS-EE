...
/**
 * <p>Java class for ForeignExchangeTradeInstructionV05 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="ForeignExchangeTradeInstructionV05">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="TradInf" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}TradeAgreement14"/>
 *         <element name="TradgSdId" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}TradePartyIdentification8"/>
 *         <element name="CtrPtySdId" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}TradePartyIdentification8"/>
 *         <element name="TradAmts" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}AmountsAndValueDate6"/>
 *         <element name="AgrdRate" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}AgreedRate3"/>
 *         <element name="NDFConds" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}NonDeliverableForwardConditions1" minOccurs="0"/>
 *         <element name="TradgSdSttlmInstrs" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}SettlementParties120" minOccurs="0"/>
 *         <element name="CtrPtySdSttlmInstrs" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}SettlementParties120" minOccurs="0"/>
 *         <element name="OptnlGnlInf" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}GeneralInformation8" minOccurs="0"/>
 *         <element name="RgltryRptg" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}RegulatoryReporting7" minOccurs="0"/>
 *         <element name="SplmtryData" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.014.001.05}SupplementaryData1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ForeignExchangeTradeInstructionV05 {
     ...
     *     
     */
    public void setTradInf(TradeAgreement14 value) {
        this.tradInf = value;
    }
