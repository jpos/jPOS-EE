 ...
 *       <sequence>
 *         <element name="TradgSdTxRptg" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}TradingSideTransactionReporting2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CtrPtySdTxRptg" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}CounterpartySideTransactionReporting2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CntrlCtrPtyClrHs" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}PartyIdentification242Choice" minOccurs="0"/>
 *         <element name="ClrBrkr" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}PartyIdentification242Choice" minOccurs="0"/>
 *         <element name="ClrXcptnPty" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}PartyIdentification242Choice" minOccurs="0"/>
 *         <element name="ClrBrkrId" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}ClearingBrokerIdentification1" minOccurs="0"/>
 *         <element name="ClrThrshldInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}YesNoIndicator" minOccurs="0"/>
 *         <element name="ClrdPdctId" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}Max35Text" minOccurs="0"/>
 *         <element name="UndrlygPdctIdr" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}UnderlyingProductIdentifier1Code" minOccurs="0"/>
 *         <element name="AllcnInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}AllocationIndicator1Code" minOccurs="0"/>
 *         <element name="CollstnInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}CollateralisationIndicator1Code" minOccurs="0"/>
 *         <element name="ExctnVn" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}Max35Text" minOccurs="0"/>
 *         <element name="ExctnTmstmp" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}DateAndDateTime2Choice" minOccurs="0"/>
 *         <element name="NonStdFlg" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}YesNoIndicator" minOccurs="0"/>
 *         <element name="LkSwpId" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}Exact42Text" minOccurs="0"/>
 *         <element name="FinNtrOfTheCtrPtyInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}YesNoIndicator" minOccurs="0"/>
 *         <element name="CollPrtflInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}YesNoIndicator" minOccurs="0"/>
 *         <element name="CollPrtflCd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}Max10Text" minOccurs="0"/>
 *         <element name="PrtflCmprssnInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}YesNoIndicator" minOccurs="0"/>
 *         <element name="CorpSctrInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}CorporateSectorIdentifier1Code" minOccurs="0"/>
 *         <element name="TradWthNonEEACtrPtyInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}YesNoIndicator" minOccurs="0"/>
 *         <element name="NtrgrpTradInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}YesNoIndicator" minOccurs="0"/>
 *         <element name="ComrclOrTrsrFincgInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}YesNoIndicator" minOccurs="0"/>
 *         <element name="FinInstrmId" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}SecurityIdentification19" minOccurs="0"/>
 *         <element name="ConfDtAndTmstmp" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}ISODateTime" minOccurs="0"/>
 *         <element name="ClrTmstmp" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}ISOTime" minOccurs="0"/>
 *         <element name="ComssnsAndFees" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}FXCommissionOrFee1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlRptgInf" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.05}Max210Text" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
