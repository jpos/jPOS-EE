 ...
 *       <sequence>
 *         <element name="ExctnPric" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}ActiveCurrencyAnd13DecimalAmount"/>
 *         <element name="LastQty" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}CurrencyAndAmount"/>
 *         <element name="SttlmTp" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}SettlementDateCode"/>
 *         <element name="SttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}ISODate"/>
 *         <element name="ValtnRate" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}AgreedRate3"/>
 *         <element name="FwdPts" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}DecimalNumber" minOccurs="0"/>
 *         <element name="ClctdCtrPtyCcyLastQty" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}CurrencyAndAmount"/>
 *         <element name="ValDt" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}ISODate"/>
 *         <element name="RskAmt" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}ActiveCurrencyAndAmount"/>
 *         <element name="SctyId" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}SecurityIdentification18"/>
 *         <element name="FxgCcy" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}CurrencyCode" minOccurs="0"/>
 *         <element name="FxgDt" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}ISODate" minOccurs="0"/>
 *         <element name="OptnInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}YesNoIndicator" minOccurs="0"/>
 *         <element name="DltaInd" type="{urn:iso:std:iso:20022:tech:xsd:fxtr.034.001.01}YesNoIndicator" minOccurs="0"/>
