 ...
 *       <sequence>
 *         <element name="IntrBkSttlmAmt" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="Amt" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}AmountType4Choice" minOccurs="0"/>
 *         <element name="IntrBkSttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}ISODate" minOccurs="0"/>
 *         <element name="ReqdColltnDt" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}ISODate" minOccurs="0"/>
 *         <element name="ReqdExctnDt" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}DateAndDateTime2Choice" minOccurs="0"/>
 *         <element name="CdtrSchmeId" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}PartyIdentification135" minOccurs="0"/>
 *         <element name="SttlmInf" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}SettlementInstruction11" minOccurs="0"/>
 *         <element name="PmtTpInf" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}PaymentTypeInformation27" minOccurs="0"/>
 *         <element name="PmtMtd" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}PaymentMethod4Code" minOccurs="0"/>
 *         <element name="MndtRltdInf" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}MandateRelatedData2Choice" minOccurs="0"/>
 *         <element name="RmtInf" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}RemittanceInformation21" minOccurs="0"/>
 *         <element name="UltmtDbtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}Party40Choice" minOccurs="0"/>
 *         <element name="Dbtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}Party40Choice" minOccurs="0"/>
 *         <element name="DbtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}CashAccount40" minOccurs="0"/>
 *         <element name="DbtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="DbtrAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}CashAccount40" minOccurs="0"/>
 *         <element name="CdtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="CdtrAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}CashAccount40" minOccurs="0"/>
 *         <element name="Cdtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}Party40Choice" minOccurs="0"/>
 *         <element name="CdtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}CashAccount40" minOccurs="0"/>
 *         <element name="UltmtCdtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}Party40Choice" minOccurs="0"/>
 *         <element name="Purp" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.13}Purpose2Choice" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
