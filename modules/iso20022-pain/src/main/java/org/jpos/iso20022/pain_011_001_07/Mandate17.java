 ...
 *       <sequence>
 *         <element name="MndtId" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}Max35Text"/>
 *         <element name="MndtReqId" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}Max35Text" minOccurs="0"/>
 *         <element name="Authntcn" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}MandateAuthentication1" minOccurs="0"/>
 *         <element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}MandateTypeInformation2" minOccurs="0"/>
 *         <element name="Ocrncs" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}MandateOccurrences5" minOccurs="0"/>
 *         <element name="TrckgInd" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}TrueFalseIndicator"/>
 *         <element name="FrstColltnAmt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="ColltnAmt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="MaxAmt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="Adjstmnt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}MandateAdjustment1" minOccurs="0"/>
 *         <element name="Rsn" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}MandateSetupReason1Choice" minOccurs="0"/>
 *         <element name="CdtrSchmeId" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}PartyIdentification135" minOccurs="0"/>
 *         <element name="Cdtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}PartyIdentification135"/>
 *         <element name="CdtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}CashAccount40" minOccurs="0"/>
 *         <element name="CdtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="UltmtCdtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}PartyIdentification135" minOccurs="0"/>
 *         <element name="Dbtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}PartyIdentification135"/>
 *         <element name="DbtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}CashAccount40" minOccurs="0"/>
 *         <element name="DbtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}BranchAndFinancialInstitutionIdentification6"/>
 *         <element name="UltmtDbtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}PartyIdentification135" minOccurs="0"/>
 *         <element name="MndtRef" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}Max35Text" minOccurs="0"/>
 *         <element name="RfrdDoc" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.07}ReferredMandateDocument1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
