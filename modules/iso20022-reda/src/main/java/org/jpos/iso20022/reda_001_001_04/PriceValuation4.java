 ...
 *       <sequence>
 *         <element name="Id" type="{urn:swift:xsd:reda.001.001.04}Max35Text" minOccurs="0"/>
 *         <element name="ValtnDtTm" type="{urn:swift:xsd:reda.001.001.04}DateAndDateTimeChoice" minOccurs="0"/>
 *         <element name="NAVDtTm" type="{urn:swift:xsd:reda.001.001.04}DateAndDateTimeChoice"/>
 *         <element name="FinInstrmDtls" type="{urn:swift:xsd:reda.001.001.04}FinancialInstrument8"/>
 *         <element name="FndMgmtCpny" type="{urn:swift:xsd:reda.001.001.04}PartyIdentification2Choice" minOccurs="0"/>
 *         <element name="TtlNAV" type="{urn:swift:xsd:reda.001.001.04}ActiveOrHistoricCurrencyAndAmount" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TtlUnitsNb" type="{urn:swift:xsd:reda.001.001.04}FinancialInstrumentQuantity1" minOccurs="0"/>
 *         <element name="NxtValtnDtTm" type="{urn:swift:xsd:reda.001.001.04}DateAndDateTimeChoice" minOccurs="0"/>
 *         <element name="PrvsValtnDtTm" type="{urn:swift:xsd:reda.001.001.04}DateAndDateTimeChoice" minOccurs="0"/>
 *         <element name="ValtnTp" type="{urn:swift:xsd:reda.001.001.04}ValuationTiming1Code"/>
 *         <element name="ValtnFrqcy" type="{urn:swift:xsd:reda.001.001.04}EventFrequency1Code" minOccurs="0"/>
 *         <element name="OffclValtnInd" type="{urn:swift:xsd:reda.001.001.04}YesNoIndicator"/>
 *         <element name="SspdInd" type="{urn:swift:xsd:reda.001.001.04}YesNoIndicator"/>
 *         <element name="PricDtls" type="{urn:swift:xsd:reda.001.001.04}UnitPrice15" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ValtnSttstcs" type="{urn:swift:xsd:reda.001.001.04}ValuationStatistics3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PrfrmncDtls" type="{urn:swift:xsd:reda.001.001.04}PerformanceFactors1" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
