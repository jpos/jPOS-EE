 ...
 *       <sequence>
 *         <element name="Ccy" type="{urn:swift:xsd:reda.001.001.04}ActiveOrHistoricCurrencyCode"/>
 *         <element name="PricTpChngBsis" type="{urn:swift:xsd:reda.001.001.04}PriceType2"/>
 *         <element name="PricChng" type="{urn:swift:xsd:reda.001.001.04}PriceValueChange1"/>
 *         <element name="Yld" type="{urn:swift:xsd:reda.001.001.04}PercentageRate" minOccurs="0"/>
 *         <element name="ByPrdfndTmPrds" type="{urn:swift:xsd:reda.001.001.04}StatisticsByPredefinedTimePeriods2" minOccurs="0"/>
 *         <element name="ByUsrDfndTmPrd" type="{urn:swift:xsd:reda.001.001.04}StatisticsByUserDefinedTimePeriod2" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
