 ...
 *       <sequence>
 *         <choice>
 *           <element name="Tp" type="{urn:swift:xsd:reda.002.001.04}TypeOfPrice9Code"/>
 *           <element name="XtndedTp" type="{urn:swift:xsd:reda.002.001.04}Extended350Code"/>
 *         </choice>
 *         <element name="PricMtd" type="{urn:swift:xsd:reda.002.001.04}PriceMethod1Code" minOccurs="0"/>
 *         <element name="ValInInvstmtCcy" type="{urn:swift:xsd:reda.002.001.04}PriceValue1" maxOccurs="unbounded"/>
 *         <element name="ValInAltrntvCcy" type="{urn:swift:xsd:reda.002.001.04}PriceValue1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ForExctnInd" type="{urn:swift:xsd:reda.002.001.04}YesNoIndicator"/>
 *         <element name="CumDvddInd" type="{urn:swift:xsd:reda.002.001.04}YesNoIndicator"/>
 *         <element name="ClctnBsis" type="{urn:swift:xsd:reda.002.001.04}PercentageRate" minOccurs="0"/>
 *         <element name="EstmtdPricInd" type="{urn:swift:xsd:reda.002.001.04}YesNoIndicator"/>
 *         <element name="NbOfDaysAcrd" type="{urn:swift:xsd:reda.002.001.04}Number" minOccurs="0"/>
 *         <element name="TaxblIncmPerShr" type="{urn:swift:xsd:reda.002.001.04}ActiveOrHistoricCurrencyAnd13DecimalAmount" minOccurs="0"/>
 *         <choice>
 *           <element name="TaxblIncmPerShrClctd" type="{urn:swift:xsd:reda.002.001.04}TaxableIncomePerShareCalculated2Code" minOccurs="0"/>
 *           <element name="XtndedTaxblIncmPerShrClctd" type="{urn:swift:xsd:reda.002.001.04}Extended350Code" minOccurs="0"/>
 *         </choice>
 *         <element name="TaxblIncmPerDvdd" type="{urn:swift:xsd:reda.002.001.04}ActiveOrHistoricCurrencyAnd13DecimalAmount" minOccurs="0"/>
 *         <choice>
 *           <element name="EUDvddSts" type="{urn:swift:xsd:reda.002.001.04}EUDividendStatus1Code" minOccurs="0"/>
 *           <element name="XtndedEUDvddSts" type="{urn:swift:xsd:reda.002.001.04}Extended350Code" minOccurs="0"/>
 *         </choice>
 *         <element name="ChrgDtls" type="{urn:swift:xsd:reda.002.001.04}Charge15" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TaxLbltyDtls" type="{urn:swift:xsd:reda.002.001.04}Tax17" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TaxRfndDtls" type="{urn:swift:xsd:reda.002.001.04}Tax17" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
