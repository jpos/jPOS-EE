...
/**
 * <p>Java class for CommonFinancialInstrumentAttributes10 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="CommonFinancialInstrumentAttributes10">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="SctySts" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}SecurityStatus3Choice" minOccurs="0"/>
 *         <element name="ISOSctyLngNm" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Max350Text" minOccurs="0"/>
 *         <element name="ISOSctyShrtNm" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Max35Text" minOccurs="0"/>
 *         <element name="NmVldFr" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}DateAndDateTime2Choice" minOccurs="0"/>
 *         <element name="DnmtnCcy" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}ActiveOrHistoricCurrencyCode"/>
 *         <element name="CertNb" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Max35Text" minOccurs="0"/>
 *         <element name="CtrctVrsnNb" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Number" minOccurs="0"/>
 *         <element name="CpnAttchdNb" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Max3NumericText" minOccurs="0"/>
 *         <element name="TaxLotNb" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Max15NumericText" minOccurs="0"/>
 *         <element name="PoolNb" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Max15NumericText" minOccurs="0"/>
 *         <element name="CvrdInd" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}YesNoIndicator" minOccurs="0"/>
 *         <element name="LglRstrctns" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}LegalRestrictions4Choice" minOccurs="0"/>
 *         <element name="PosLmt" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}FinancialInstrumentQuantity1Choice" minOccurs="0"/>
 *         <element name="NearTermPosLmt" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}FinancialInstrumentQuantity1Choice" minOccurs="0"/>
 *         <element name="ListgDt" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}ISODate" minOccurs="0"/>
 *         <element name="RcrdDt" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}ISODateTime" minOccurs="0"/>
 *         <element name="XpryDt" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}ISODate" minOccurs="0"/>
 *         <element name="Purp" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Max256Text" minOccurs="0"/>
 *         <element name="ClssfctnTp" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}ClassificationType2" minOccurs="0"/>
 *         <element name="Issnc" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Issuance5" minOccurs="0"/>
 *         <element name="TradgMkt" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}TradingParameters2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SprdAndBchmkCrv" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}BenchmarkCurve6" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PutTp" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}PutType3Choice" minOccurs="0"/>
 *         <element name="CallTp" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}CallType3Choice" minOccurs="0"/>
 *         <element name="FngbInd" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}YesNoIndicator" minOccurs="0"/>
 *         <element name="Cnfdtl" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}YesNoIndicator" minOccurs="0"/>
 *         <element name="PrvtPlcmnt" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}YesNoIndicator" minOccurs="0"/>
 *         <element name="ConvtblInd" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}YesNoIndicator" minOccurs="0"/>
 *         <element name="ConvsPrd" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}DateTimePeriod1" minOccurs="0"/>
 *         <element name="ConvsRatioNmrtr" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}FinancialInstrumentQuantity1Choice" minOccurs="0"/>
 *         <element name="ConvsRatioDnmtr" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}FinancialInstrumentQuantity1Choice" minOccurs="0"/>
 *         <element name="PmryPlcOfDpst" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}PartyIdentification136" minOccurs="0"/>
 *         <element name="TradgMtd" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}UnitOrFaceAmount1Choice" minOccurs="0"/>
 *         <element name="TEFRARule" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}TEFRARules3Choice" minOccurs="0"/>
 *         <element name="SrNb" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Max16Text" minOccurs="0"/>
 *         <element name="Clss" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Max16Text" minOccurs="0"/>
 *         <element name="WhldgTaxRgm" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}SecurityWithHoldingTax1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PmtSts" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}SecuritiesPaymentStatus5Choice" minOccurs="0"/>
 *         <element name="InitlPhysForm" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}InitialPhysicalForm4Choice" minOccurs="0"/>
 *         <element name="AftrXchgPhysForm" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}InitialPhysicalForm3Choice" minOccurs="0"/>
 *         <element name="CmonSfkpr" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}AnyBICDec2014Identifier" minOccurs="0"/>
 *         <element name="RedTp" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}MaturityRedemptionType3Choice" minOccurs="0"/>
 *         <element name="RedPmtCcy" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="Rstrctn" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}SecurityRestriction3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SttlmInf" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}SettlementInformation17" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FinInstrmForm" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}FinancialInstrumentForm2" minOccurs="0"/>
 *         <element name="CtctNm" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Organisation38" minOccurs="0"/>
 *         <element name="LeadMgr" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Organisation38" minOccurs="0"/>
 *         <element name="PrncplPngAgt" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Organisation38" minOccurs="0"/>
 *         <element name="PngAgt" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Organisation38" minOccurs="0"/>
 *         <element name="Dpstry" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Organisation38" minOccurs="0"/>
 *         <element name="UndrlygRsk" type="{urn:iso:std:iso:20022:tech:xsd:reda.006.001.01}Organisation38" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class CommonFinancialInstrumentAttributes10 {
     ...
     *     
     */
    public void setCmonSfkpr(String value) {
