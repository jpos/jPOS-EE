 ...
 *       <sequence>
 *         <element name="TradLegId" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}Max35Text"/>
 *         <element name="TradId" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="TradExctnId" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}Max35Text"/>
 *         <element name="OrdrId" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="AllcnId" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="Sts" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}Status5Code" minOccurs="0"/>
 *         <element name="TradDt" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}ISODateTime"/>
 *         <element name="TxDtTm" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}ISODateTime" minOccurs="0"/>
 *         <element name="SttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}DateFormat15Choice" minOccurs="0"/>
 *         <element name="FinInstrmId" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}SecurityIdentification14"/>
 *         <element name="TradgCcy" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}CurrencyCode" minOccurs="0"/>
 *         <element name="BuySellInd" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}Side1Code"/>
 *         <element name="TradQty" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}FinancialInstrumentQuantity1Choice"/>
 *         <element name="DealPric" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}Price4"/>
 *         <element name="GrssAmt" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}AmountAndDirection21" minOccurs="0"/>
 *         <element name="AcrdIntrstAmt" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}AmountAndDirection21" minOccurs="0"/>
 *         <element name="PlcOfTrad" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}MarketIdentification84"/>
 *         <element name="PlcOfListg" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}MarketIdentification85" minOccurs="0"/>
 *         <element name="TradTp" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}TradeType1Code"/>
 *         <element name="DerivRltdTrad" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}YesNoIndicator" minOccurs="0"/>
 *         <element name="Brkr" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}PartyIdentificationAndAccount100" minOccurs="0"/>
 *         <element name="TradgPty" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}PartyIdentification35Choice"/>
 *         <element name="TradRegnOrgn" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}Max35Text" minOccurs="0"/>
 *         <element name="TradgPtyAcct" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}SecuritiesAccount19" minOccurs="0"/>
 *         <element name="TradgCpcty" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}TradingCapacity5Code"/>
 *         <element name="TradPstngCd" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}TradePosting1Code" minOccurs="0"/>
 *         <element name="SfkpgPlc" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}SafekeepingPlaceFormat7Choice" minOccurs="0"/>
 *         <element name="SfkpgAcct" type="{urn:iso:std:iso:20022:tech:xsd:secl.001.001.03}SecuritiesAccount19" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
