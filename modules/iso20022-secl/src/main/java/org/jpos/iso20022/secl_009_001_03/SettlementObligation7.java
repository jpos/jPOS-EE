 ...
 *       <sequence>
 *         <element name="CSDTxId" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}Max35Text" minOccurs="0"/>
 *         <element name="CntrlCtrPtyTxId" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}Max35Text" minOccurs="0"/>
 *         <element name="PrvsBuyInId" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}Max35Text" minOccurs="0"/>
 *         <element name="DlvryAcct" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}SecuritiesAccount19" minOccurs="0"/>
 *         <element name="SfkpgPlc" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}SafekeepingPlaceFormat7Choice" minOccurs="0"/>
 *         <element name="SfkpgAcct" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}SecuritiesAccount19" minOccurs="0"/>
 *         <element name="ClrSgmt" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}PartyIdentification35Choice" minOccurs="0"/>
 *         <element name="NonClrMmb" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}PartyIdentificationAndAccount31" minOccurs="0"/>
 *         <element name="IntnddSttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}ISODate" minOccurs="0"/>
 *         <element name="FinInstrmId" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}SecurityIdentification14"/>
 *         <element name="TradDt" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}ISODate" minOccurs="0"/>
 *         <element name="DealPric" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}Price4" minOccurs="0"/>
 *         <element name="Qty" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}FinancialInstrumentQuantity1Choice"/>
 *         <element name="Dpstry" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}PartyIdentification34Choice" minOccurs="0"/>
 *         <element name="RmngQtyToBeSttld" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}FinancialInstrumentQuantity1Choice" minOccurs="0"/>
 *         <element name="SttlmAmt" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}AmountAndDirection27"/>
 *         <element name="RmngAmtToBeSttld" type="{urn:iso:std:iso:20022:tech:xsd:secl.009.001.03}AmountAndDirection27" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
