 ...
 *       <sequence>
 *         <element name="OptnNb" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}Exact3NumericText"/>
 *         <element name="OptnTp" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}CorporateActionOption1FormatChoice"/>
 *         <element name="OptnAvlbtySts" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}CorporateActionEventStatus2FormatChoice"/>
 *         <element name="CertfctnInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}YesNoIndicator" minOccurs="0"/>
 ...
 *         <element name="AssntdLineSctyId" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}SecurityIdentification7" minOccurs="0"/>
 *         <element name="AgtSctiesAcctId" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}Max35Text" minOccurs="0"/>
 *         <element name="AgtCshAcctId" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}AccountIdentification2Choice" minOccurs="0"/>
 ...
 *         <element name="WdrwlAllwdInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}YesNoIndicator"/>
 *         <element name="ChngAllwdInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}YesNoIndicator"/>
 *         <element name="DtDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}CorporateActionDate4" minOccurs="0"/>
 *         <element name="RateAndAmtDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}CorporateActionRate2" minOccurs="0"/>
 *         <element name="PricDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}CorporateActionPrice1" minOccurs="0"/>
 *         <element name="PrdDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}CorporateActionPeriod2" minOccurs="0"/>
 *         <element name="SctiesMvmntDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}SecurityOption1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CshMvmntDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}CashOption1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CorpActnOthrAgtDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}CorporateActionAgent1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FrctnDspstn" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}FractionDispositionType1FormatChoice" minOccurs="0"/>
 *         <element name="RedChrgsApldInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}YesNoIndicator" minOccurs="0"/>
 *         <element name="OptnFeatrs" type="{urn:iso:std:iso:20022:tech:xsd:seev.009.001.01}OptionFeatures1FormatChoice" maxOccurs="unbounded" minOccurs="0"/>
