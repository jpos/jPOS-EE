...
/**
 * <p>Java class for CorporateActionNotification002V13 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="CorporateActionNotification002V13">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="Pgntn" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}Pagination1" minOccurs="0"/>
 *         <element name="NtfctnGnlInf" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}CorporateActionNotification8"/>
 *         <element name="PrvsNtfctnId" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}DocumentIdentification37" minOccurs="0"/>
 *         <element name="InstrId" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}DocumentIdentification17" minOccurs="0"/>
 *         <element name="OthrDocId" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}DocumentIdentification38" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="EvtsLkg" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}CorporateActionEventReference4" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CorpActnGnlInf" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}CorporateActionGeneralInformation170"/>
 *         <element name="AcctDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}AccountIdentification57Choice"/>
 *         <element name="IntrmdtScty" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}FinancialInstrumentAttributes117" minOccurs="0"/>
 *         <element name="CorpActnDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}CorporateAction79" minOccurs="0"/>
 *         <element name="CorpActnOptnDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}CorporateActionOption216" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}CorporateActionNarrative55" minOccurs="0"/>
 *         <element name="IssrAgt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification151Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PngAgt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification137Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SubPngAgt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification137Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Regar" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification137Choice" minOccurs="0"/>
 *         <element name="RsellngAgt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification137Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PhysSctiesAgt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification137Choice" minOccurs="0"/>
 *         <element name="DrpAgt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification137Choice" minOccurs="0"/>
 *         <element name="SlctnAgt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification137Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="InfAgt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification137Choice" minOccurs="0"/>
 *         <element name="Issr" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification151Choice" minOccurs="0"/>
 *         <element name="Offerr" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification151Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TrfAgt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PartyIdentification151Choice" minOccurs="0"/>
 *         <element name="SplmtryData" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}SupplementaryData1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class CorporateActionNotification002V13 {
     ...
     *     
     */
    public void setNtfctnGnlInf(CorporateActionNotification8 value) {
     ...
     *     
     */
    public void setPrvsNtfctnId(DocumentIdentification37 value) {
     ...
     *     
     */
    public void setCorpActnGnlInf(CorporateActionGeneralInformation170 value) {
     ...
     *     
     */
    public void setAcctDtls(AccountIdentification57Choice value) {
        this.acctDtls = value;
    }
     ...
     *     
     */
    public void setIntrmdtScty(FinancialInstrumentAttributes117 value) {
     ...
     *     
     */
    public void setCorpActnDtls(CorporateAction79 value) {
     ...
     *     
     */
    public void setAddtlInf(CorporateActionNarrative55 value) {
        this.addtlInf = value;
    }
