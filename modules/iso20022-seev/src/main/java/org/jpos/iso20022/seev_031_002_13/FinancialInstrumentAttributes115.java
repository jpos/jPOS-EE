 ...
 *       <sequence>
 *         <element name="FinInstrmId" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}SecurityIdentification20"/>
 *         <element name="PlcOfListg" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}MarketIdentification4Choice" minOccurs="0"/>
 *         <element name="DayCntBsis" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}InterestComputationMethodFormat5Choice" minOccurs="0"/>
 *         <element name="ClssfctnTp" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ClassificationType33Choice" minOccurs="0"/>
 *         <element name="OptnStyle" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}OptionStyle9Choice" minOccurs="0"/>
 *         <element name="DnmtnCcy" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ActiveOrHistoricCurrencyCode" minOccurs="0"/>
 *         <element name="NxtCpnDt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ISODate" minOccurs="0"/>
 *         <element name="FltgRateFxgDt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ISODate" minOccurs="0"/>
 *         <element name="MtrtyDt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ISODate" minOccurs="0"/>
 *         <element name="IsseDt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ISODate" minOccurs="0"/>
 *         <element name="NxtCllblDt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ISODate" minOccurs="0"/>
 *         <element name="PutblDt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ISODate" minOccurs="0"/>
 *         <element name="DtdDt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ISODate" minOccurs="0"/>
 *         <element name="ConvsDt" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}ISODate" minOccurs="0"/>
 ...
 *         <element name="IntrstRate" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}RateFormat3Choice" minOccurs="0"/>
 *         <element name="NxtIntrstRate" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}RateFormat3Choice" minOccurs="0"/>
 *         <element name="MinNmnlQty" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}FinancialInstrumentQuantity36Choice" minOccurs="0"/>
 *         <element name="MinQtyToInst" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}FinancialInstrumentQuantity36Choice" minOccurs="0"/>
 *         <element name="MinMltplQtyToInst" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}FinancialInstrumentQuantity36Choice" minOccurs="0"/>
 *         <element name="CtrctSz" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}FinancialInstrumentQuantity36Choice" minOccurs="0"/>
 *         <element name="IssePric" type="{urn:iso:std:iso:20022:tech:xsd:seev.031.002.13}PriceFormat57Choice" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
