...
/**
 * <p>Java class for CorporateActionOption204 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="CorporateActionOption204">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="OptnNb" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}OptionNumber1Choice"/>
 *         <element name="OptnTp" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}CorporateActionOption43Choice"/>
 *         <element name="OptnFeatrs" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}OptionFeaturesFormat27Choice" minOccurs="0"/>
 *         <element name="FrctnDspstn" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}FractionDispositionType29Choice" minOccurs="0"/>
 *         <element name="ChngTp" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}CorporateActionChangeTypeFormat7Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ElgblForCollInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}YesNoIndicator" minOccurs="0"/>
 *         <element name="SlctnDealrFeeInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}YesNoIndicator" minOccurs="0"/>
 *         <element name="CcyToBuy" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="CcyToSell" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="CcyOptn" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="SctyId" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}SecurityIdentification20" minOccurs="0"/>
 *         <element name="SctiesQtyOrInstdAmt" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}SecuritiesQuantityOrAmount7Choice"/>
 *         <element name="ExctnReqdDtTm" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}DateAndDateTime2Choice" minOccurs="0"/>
 *         <element name="RateAndAmtDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}CorporateActionRate73" minOccurs="0"/>
 *         <element name="PricDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}CorporateActionPrice77" minOccurs="0"/>
 *         <element name="ShrhldrNb" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}RestrictedFINXMax25Text" minOccurs="0"/>
 *         <element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:seev.033.002.12}CorporateActionNarrative33" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class CorporateActionOption204 {
     ...
     *     
     */
    public void setFrctnDspstn(FractionDispositionType29Choice value) {
     ...
     *     
     */
    public void setSctiesQtyOrInstdAmt(SecuritiesQuantityOrAmount7Choice value) {
     ...
     *     
     */
    public void setRateAndAmtDtls(CorporateActionRate73 value) {
     ...
     *     
     */
    public void setPricDtls(CorporateActionPrice77 value) {
        this.pricDtls = value;
    }
     ...
     *     
     */
    public void setAddtlInf(CorporateActionNarrative33 value) {
        this.addtlInf = value;
    }
