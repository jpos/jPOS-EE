...
/**
 * <p>Java class for CorporateActionOption214 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="CorporateActionOption214">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="OptnNb" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}Exact3NumericText"/>
 *         <element name="OptnTp" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}CorporateActionOption46Choice"/>
 *         <element name="FrctnDspstn" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}FractionDispositionType31Choice" minOccurs="0"/>
 *         <element name="OfferTp" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}OfferTypeFormat13Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="OptnFeatrs" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}OptionFeaturesFormat26Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="OptnAvlbtySts" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}OptionAvailabilityStatus4Choice" minOccurs="0"/>
 *         <element name="CertfctnBrkdwnTp" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}BeneficiaryCertificationType12Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="NonDmclCtry" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}CountryCode" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="VldDmclCtry" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}CountryCode" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CcyOptn" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="DfltPrcgOrStgInstr" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}DefaultProcessingOrStandingInstruction1Choice"/>
 *         <element name="ChrgsApldInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}YesNoIndicator" minOccurs="0"/>
 *         <element name="CertfctnBrkdwnInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}YesNoIndicator" minOccurs="0"/>
 *         <element name="WdrwlAllwdInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}YesNoIndicator" minOccurs="0"/>
 *         <element name="ChngAllwdInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}YesNoIndicator" minOccurs="0"/>
 *         <element name="ApldOptnInd" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}YesNoIndicator" minOccurs="0"/>
 *         <element name="SctyId" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}SecurityIdentification20" minOccurs="0"/>
 *         <element name="DtDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}CorporateActionDate81" minOccurs="0"/>
 *         <element name="PrdDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}CorporateActionPeriod12" minOccurs="0"/>
 *         <element name="RateAndAmtDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}CorporateActionRate109" minOccurs="0"/>
 *         <element name="PricDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}CorporateActionPrice69" minOccurs="0"/>
 *         <element name="SctiesQty" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}SecuritiesOption84" minOccurs="0"/>
 *         <element name="SctiesMvmntDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}SecuritiesOption96" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CshMvmntDtls" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}CashOption88" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:seev.035.002.14}CorporateActionNarrative36" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class CorporateActionOption214 {
     ...
     *     
     */
    public void setOptnTp(CorporateActionOption46Choice value) {
        this.optnTp = value;
    }
     ...
     *     
     */
    public void setOptnAvlbtySts(OptionAvailabilityStatus4Choice value) {
     ...
     *     
     */
    public void setDtDtls(CorporateActionDate81 value) {
        this.dtDtls = value;
    }
     ...
     *     
     */
    public void setRateAndAmtDtls(CorporateActionRate109 value) {
     ...
     *     
     */
    public void setPricDtls(CorporateActionPrice69 value) {
        this.pricDtls = value;
    }
     ...
     *     
     */
    public void setSctiesQty(SecuritiesOption84 value) {
     ...
     *     
     */
    public void setAddtlInf(CorporateActionNarrative36 value) {
        this.addtlInf = value;
    }
