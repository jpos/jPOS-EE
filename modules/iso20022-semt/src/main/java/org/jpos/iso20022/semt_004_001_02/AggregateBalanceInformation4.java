...
/**
 * <p>Java class for AggregateBalanceInformation4 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="AggregateBalanceInformation4">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="AggtQty" type="{urn:swift:xsd:semt.004.001.02}BalanceQuantity1Choice"/>
 *         <element name="AvlblQty" type="{urn:swift:xsd:semt.004.001.02}BalanceQuantity1Choice" minOccurs="0"/>
 *         <element name="NotAvlblQty" type="{urn:swift:xsd:semt.004.001.02}BalanceQuantity1Choice" minOccurs="0"/>
 *         <element name="DaysAcrd" type="{urn:swift:xsd:semt.004.001.02}Number" minOccurs="0"/>
 *         <element name="HldgVal" type="{urn:swift:xsd:semt.004.001.02}ActiveOrHistoricCurrencyAndAmount" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PrvsHldgVal" type="{urn:swift:xsd:semt.004.001.02}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="AcrdIntrstAmt" type="{urn:swift:xsd:semt.004.001.02}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="AcrdIntrstAmtSgn" type="{urn:swift:xsd:semt.004.001.02}PlusOrMinusIndicator" minOccurs="0"/>
 *         <element name="BookVal" type="{urn:swift:xsd:semt.004.001.02}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="SfkpgPlc" type="{urn:swift:xsd:semt.004.001.02}SafekeepingPlaceFormatChoice" minOccurs="0"/>
 *         <element name="FinInstrmDtls" type="{urn:swift:xsd:semt.004.001.02}FinancialInstrument13"/>
 *         <element name="PricDtls" type="{urn:swift:xsd:semt.004.001.02}PriceInformation2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FXDtls" type="{urn:swift:xsd:semt.004.001.02}ForeignExchangeTerms6" minOccurs="0"/>
 *         <element name="BalBrkdwnDtls" type="{urn:swift:xsd:semt.004.001.02}SubBalanceInformation2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlBalBrkdwnDtls" type="{urn:swift:xsd:semt.004.001.02}AdditionalBalanceInformation2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="BalAtSfkpgPlc" type="{urn:swift:xsd:semt.004.001.02}AggregateBalancePerSafekeepingPlace3" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class AggregateBalanceInformation4 {
     ...
     *     
     */
    public void setAvlblQty(BalanceQuantity1Choice value) {
        this.avlblQty = value;
    }
     ...
     *     
     */
    public void setNotAvlblQty(BalanceQuantity1Choice value) {
