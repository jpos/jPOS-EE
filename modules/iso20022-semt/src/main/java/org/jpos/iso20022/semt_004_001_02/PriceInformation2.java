 ...
 *       <sequence>
 *         <element name="Val" type="{urn:swift:xsd:semt.004.001.02}PriceRateOrAmountOrUnknownChoice"/>
 *         <element name="ValTp" type="{urn:swift:xsd:semt.004.001.02}PriceValueType2Code" minOccurs="0"/>
 *         <choice>
 *           <element name="Tp" type="{urn:swift:xsd:semt.004.001.02}TypeOfPrice11Code"/>
 *           <element name="XtndedTp" type="{urn:swift:xsd:semt.004.001.02}Extended350Code"/>
 *         </choice>
 *         <element name="SrcOfPric" type="{urn:swift:xsd:semt.004.001.02}PriceSourceFormatChoice" minOccurs="0"/>
 *         <element name="QtnDt" type="{urn:swift:xsd:semt.004.001.02}DateAndDateTimeChoice" minOccurs="0"/>
 *         <element name="Yldd" type="{urn:swift:xsd:semt.004.001.02}YesNoIndicator" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
