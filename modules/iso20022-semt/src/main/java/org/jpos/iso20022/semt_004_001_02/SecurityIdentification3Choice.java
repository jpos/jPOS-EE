 ...
 *       <sequence>
 *         <choice>
 *           <element name="ISIN" type="{urn:swift:xsd:semt.004.001.02}ISINIdentifier"/>
 *           <element name="SEDOL" type="{urn:swift:xsd:semt.004.001.02}SEDOLIdentifier"/>
 *           <element name="CUSIP" type="{urn:swift:xsd:semt.004.001.02}CUSIPIdentifier"/>
 *           <element name="RIC" type="{urn:swift:xsd:semt.004.001.02}RICIdentifier"/>
 *           <element name="TckrSymb" type="{urn:swift:xsd:semt.004.001.02}TickerIdentifier"/>
 *           <element name="Blmbrg" type="{urn:swift:xsd:semt.004.001.02}BloombergIdentifier"/>
 *           <element name="CTA" type="{urn:swift:xsd:semt.004.001.02}ConsolidatedTapeAssociationIdentifier"/>
 *           <element name="QUICK" type="{urn:swift:xsd:semt.004.001.02}QUICKIdentifier"/>
 *           <element name="Wrtppr" type="{urn:swift:xsd:semt.004.001.02}WertpapierIdentifier"/>
 *           <element name="Dtch" type="{urn:swift:xsd:semt.004.001.02}DutchIdentifier"/>
 *           <element name="Vlrn" type="{urn:swift:xsd:semt.004.001.02}ValorenIdentifier"/>
 *           <element name="SCVM" type="{urn:swift:xsd:semt.004.001.02}SicovamIdentifier"/>
 *           <element name="Belgn" type="{urn:swift:xsd:semt.004.001.02}BelgianIdentifier"/>
 *           <element name="Cmon" type="{urn:swift:xsd:semt.004.001.02}EuroclearClearstreamIdentifier"/>
 *           <element name="OthrPrtryId" type="{urn:swift:xsd:semt.004.001.02}AlternateSecurityIdentification1"/>
 *         </choice>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
