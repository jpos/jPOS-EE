 ...
 *       <sequence>
 *         <element name="UnitCcy" type="{urn:swift:xsd:semt.005.001.02}ActiveOrHistoricCurrencyCode"/>
 *         <element name="QtdCcy" type="{urn:swift:xsd:semt.005.001.02}ActiveOrHistoricCurrencyCode"/>
 *         <element name="XchgRate" type="{urn:swift:xsd:semt.005.001.02}BaseOneRate"/>
 *         <element name="QtnDt" type="{urn:swift:xsd:semt.005.001.02}ISODateTime" minOccurs="0"/>
 *         <element name="QtgInstn" type="{urn:swift:xsd:semt.005.001.02}PartyIdentification2Choice" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
