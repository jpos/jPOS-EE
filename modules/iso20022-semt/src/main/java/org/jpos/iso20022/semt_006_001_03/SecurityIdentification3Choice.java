 ...
 *       <sequence>
 *         <choice>
 *           <element name="ISIN" type="{urn:swift:xsd:semt.006.001.03}ISINIdentifier"/>
 *           <element name="SEDOL" type="{urn:swift:xsd:semt.006.001.03}SEDOLIdentifier"/>
 *           <element name="CUSIP" type="{urn:swift:xsd:semt.006.001.03}CUSIPIdentifier"/>
 *           <element name="RIC" type="{urn:swift:xsd:semt.006.001.03}RICIdentifier"/>
 *           <element name="TckrSymb" type="{urn:swift:xsd:semt.006.001.03}TickerIdentifier"/>
 *           <element name="Blmbrg" type="{urn:swift:xsd:semt.006.001.03}BloombergIdentifier"/>
 *           <element name="CTA" type="{urn:swift:xsd:semt.006.001.03}ConsolidatedTapeAssociationIdentifier"/>
 *           <element name="QUICK" type="{urn:swift:xsd:semt.006.001.03}QUICKIdentifier"/>
 *           <element name="Wrtppr" type="{urn:swift:xsd:semt.006.001.03}WertpapierIdentifier"/>
 *           <element name="Dtch" type="{urn:swift:xsd:semt.006.001.03}DutchIdentifier"/>
 *           <element name="Vlrn" type="{urn:swift:xsd:semt.006.001.03}ValorenIdentifier"/>
 *           <element name="SCVM" type="{urn:swift:xsd:semt.006.001.03}SicovamIdentifier"/>
 *           <element name="Belgn" type="{urn:swift:xsd:semt.006.001.03}BelgianIdentifier"/>
 *           <element name="Cmon" type="{urn:swift:xsd:semt.006.001.03}EuroclearClearstreamIdentifier"/>
 *           <element name="OthrPrtryId" type="{urn:swift:xsd:semt.006.001.03}AlternateSecurityIdentification1"/>
 *         </choice>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
