 ...
 *       <sequence>
 *         <element name="BldgNm" type="{urn:swift:xsd:semt.006.001.03}Max35Text" minOccurs="0"/>
 *         <element name="StrtNm" type="{urn:swift:xsd:semt.006.001.03}Max35Text" minOccurs="0"/>
 *         <element name="StrtBldgId" type="{urn:swift:xsd:semt.006.001.03}Max35Text" minOccurs="0"/>
 *         <element name="Flr" type="{urn:swift:xsd:semt.006.001.03}Max16Text" minOccurs="0"/>
 *         <element name="TwnNm" type="{urn:swift:xsd:semt.006.001.03}Max35Text"/>
 *         <element name="DstrctNm" type="{urn:swift:xsd:semt.006.001.03}Max35Text" minOccurs="0"/>
 *         <element name="RgnId" type="{urn:swift:xsd:semt.006.001.03}Max35Text" minOccurs="0"/>
 *         <element name="Stat" type="{urn:swift:xsd:semt.006.001.03}Max35Text" minOccurs="0"/>
 *         <element name="CtyId" type="{urn:swift:xsd:semt.006.001.03}Max35Text" minOccurs="0"/>
 *         <element name="Ctry" type="{urn:swift:xsd:semt.006.001.03}CountryCode"/>
 *         <element name="PstCdId" type="{urn:swift:xsd:semt.006.001.03}Max16Text"/>
 *         <element name="POB" type="{urn:swift:xsd:semt.006.001.03}Max16Text" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
