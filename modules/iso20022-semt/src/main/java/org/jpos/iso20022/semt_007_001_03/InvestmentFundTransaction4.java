 ...
 *       <sequence>
 *         <element name="EvtTp" type="{urn:swift:xsd:semt.007.001.03}TransactionType1Choice"/>
 *         <element name="BookgSts" type="{urn:swift:xsd:semt.007.001.03}TransactionStatus1Code" minOccurs="0"/>
 *         <element name="MstrRef" type="{urn:swift:xsd:semt.007.001.03}Max35Text" minOccurs="0"/>
 *         <element name="OrdrRef" type="{urn:swift:xsd:semt.007.001.03}Max35Text" minOccurs="0"/>
 *         <element name="ClntRef" type="{urn:swift:xsd:semt.007.001.03}Max35Text" minOccurs="0"/>
 *         <element name="DealRef" type="{urn:swift:xsd:semt.007.001.03}Max35Text" minOccurs="0"/>
 *         <element name="LegId" type="{urn:swift:xsd:semt.007.001.03}Max35Text" minOccurs="0"/>
 *         <element name="LegExctnId" type="{urn:swift:xsd:semt.007.001.03}Max35Text" minOccurs="0"/>
 *         <element name="OrdrDtTm" type="{urn:swift:xsd:semt.007.001.03}ISODateTime" minOccurs="0"/>
 *         <element name="SttldTxInd" type="{urn:swift:xsd:semt.007.001.03}YesNoIndicator"/>
 *         <element name="RegdTxInd" type="{urn:swift:xsd:semt.007.001.03}YesNoIndicator"/>
 *         <element name="UnitsQty" type="{urn:swift:xsd:semt.007.001.03}FinancialInstrumentQuantity1"/>
 *         <element name="CdtDbt" type="{urn:swift:xsd:semt.007.001.03}CreditDebitCode"/>
 *         <element name="Rvsl" type="{urn:swift:xsd:semt.007.001.03}ReversalCode" minOccurs="0"/>
 *         <element name="SttlmAmt" type="{urn:swift:xsd:semt.007.001.03}ActiveCurrencyAndAmount" minOccurs="0"/>
 *         <element name="SttlmDt" type="{urn:swift:xsd:semt.007.001.03}ISODate" minOccurs="0"/>
 *         <element name="TradDtTm" type="{urn:swift:xsd:semt.007.001.03}DateAndDateTimeChoice"/>
 *         <element name="CumDvddInd" type="{urn:swift:xsd:semt.007.001.03}YesNoIndicator"/>
 *         <element name="PrtlyExctdInd" type="{urn:swift:xsd:semt.007.001.03}YesNoIndicator"/>
 *         <element name="PricDtls" type="{urn:swift:xsd:semt.007.001.03}UnitPrice20" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
