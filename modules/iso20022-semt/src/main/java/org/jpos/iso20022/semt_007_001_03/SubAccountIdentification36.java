 ...
 *       <sequence>
 *         <element name="Id" type="{urn:swift:xsd:semt.007.001.03}AccountIdentificationFormatChoice"/>
 *         <element name="ActvtyInd" type="{urn:swift:xsd:semt.007.001.03}YesNoIndicator"/>
 *         <element name="TxOnSubAcct" type="{urn:swift:xsd:semt.007.001.03}InvestmentFundTransactionsByFund3" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
