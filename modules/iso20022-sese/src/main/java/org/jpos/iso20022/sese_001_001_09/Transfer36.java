 ...
 *       <sequence>
 *         <element name="TrfRef" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}Max35Text"/>
 *         <element name="ClntRef" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}AdditionalReference10" minOccurs="0"/>
 *         <element name="CtrPtyRef" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}AdditionalReference10" minOccurs="0"/>
 *         <element name="BizFlowTp" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}BusinessFlowType1Code" minOccurs="0"/>
 *         <element name="ReqdTrfDt" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}DateFormat1Choice" minOccurs="0"/>
 *         <element name="ReqdSttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}ISODate" minOccurs="0"/>
 *         <element name="TrfOrdrDtForm" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}ISODate" minOccurs="0"/>
 *         <element name="TrfRsn" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}TransferReason1Choice" minOccurs="0"/>
 *         <element name="HldgsPlanTp" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}HoldingsPlanType1Code" maxOccurs="3" minOccurs="0"/>
 *         <element name="FinInstrmDtls" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}FinancialInstrument88"/>
 *         <element name="Qty" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}Quantity42Choice"/>
 *         <element name="UnitsDtls" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}Unit12" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Rndg" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}RoundingDirection2Code" minOccurs="0"/>
 *         <element name="OrgnlCost" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}ActiveCurrencyAnd13DecimalAmount" minOccurs="0"/>
 *         <element name="AvrgPric" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}ActiveOrHistoricCurrencyAnd13DecimalAmount" minOccurs="0"/>
 *         <element name="TrfCcy" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}ActiveOrHistoricCurrencyCode" minOccurs="0"/>
 *         <element name="OwnAcctTrfInd" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}YesNoIndicator" minOccurs="0"/>
 *         <element name="NonStdSttlmInf" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}Max350Text" minOccurs="0"/>
 *         <element name="TrfExpnssPmtTp" type="{urn:iso:std:iso:20022:tech:xsd:sese.001.001.09}ChargePaymentMethod1Choice" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
