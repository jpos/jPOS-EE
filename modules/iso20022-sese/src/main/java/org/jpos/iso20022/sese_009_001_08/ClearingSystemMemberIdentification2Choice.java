 ...
 *       <choice>
 *         <element name="USCHU" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}CHIPSUniversalIdentifier"/>
 *         <element name="NZNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}NewZealandNCCIdentifier"/>
 *         <element name="IENSC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}IrishNSCIdentifier"/>
 *         <element name="GBSC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}UKDomesticSortCodeIdentifier"/>
 *         <element name="USCH" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}CHIPSParticipantIdentifier"/>
 *         <element name="CHBC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}SwissBCIdentifier"/>
 *         <element name="USFW" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}FedwireRoutingNumberIdentifier"/>
 *         <element name="PTNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}PortugueseNCCIdentifier"/>
 *         <element name="RUCB" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}RussianCentralBankIdentificationCodeIdentifier"/>
 *         <element name="ITNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}ItalianDomesticIdentifier"/>
 *         <element name="ATBLZ" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}AustrianBankleitzahlIdentifier"/>
 *         <element name="CACPA" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}CanadianPaymentsARNIdentifier"/>
 *         <element name="CHSIC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}SwissSICIdentifier"/>
 *         <element name="DEBLZ" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}GermanBankleitzahlIdentifier"/>
 *         <element name="ESNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}SpanishDomesticInterbankingIdentifier"/>
 *         <element name="ZANCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}SouthAfricanNCCIdentifier"/>
 *         <element name="HKNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}HongKongBankIdentifier"/>
 *         <element name="AUBSBx" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}ExtensiveBranchNetworkIdentifier"/>
 *         <element name="AUBSBs" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}SmallNetworkIdentifier"/>
 *         <element name="INIFSC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}IndianFinancialSystemCodeIdentifier"/>
 *         <element name="GRHEBIC" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}HellenicBankIdentificationCodeIdentifier"/>
 *         <element name="PLKNR" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}PolishNationalClearingCodeIdentifier"/>
 *         <element name="OthrClrCdId" type="{urn:iso:std:iso:20022:tech:xsd:sese.009.001.08}Max35Text"/>
 *       </choice>
 *     </restriction>
 *   </complexContent>
 * </complexType>
