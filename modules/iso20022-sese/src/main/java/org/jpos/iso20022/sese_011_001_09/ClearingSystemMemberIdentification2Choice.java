 ...
 *       <choice>
 *         <element name="USCHU" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}CHIPSUniversalIdentifier"/>
 *         <element name="NZNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}NewZealandNCCIdentifier"/>
 *         <element name="IENSC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}IrishNSCIdentifier"/>
 *         <element name="GBSC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}UKDomesticSortCodeIdentifier"/>
 *         <element name="USCH" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}CHIPSParticipantIdentifier"/>
 *         <element name="CHBC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}SwissBCIdentifier"/>
 *         <element name="USFW" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}FedwireRoutingNumberIdentifier"/>
 *         <element name="PTNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}PortugueseNCCIdentifier"/>
 *         <element name="RUCB" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}RussianCentralBankIdentificationCodeIdentifier"/>
 *         <element name="ITNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}ItalianDomesticIdentifier"/>
 *         <element name="ATBLZ" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}AustrianBankleitzahlIdentifier"/>
 *         <element name="CACPA" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}CanadianPaymentsARNIdentifier"/>
 *         <element name="CHSIC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}SwissSICIdentifier"/>
 *         <element name="DEBLZ" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}GermanBankleitzahlIdentifier"/>
 *         <element name="ESNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}SpanishDomesticInterbankingIdentifier"/>
 *         <element name="ZANCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}SouthAfricanNCCIdentifier"/>
 *         <element name="HKNCC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}HongKongBankIdentifier"/>
 *         <element name="AUBSBx" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}ExtensiveBranchNetworkIdentifier"/>
 *         <element name="AUBSBs" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}SmallNetworkIdentifier"/>
 *         <element name="INIFSC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}IndianFinancialSystemCodeIdentifier"/>
 *         <element name="GRHEBIC" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}HellenicBankIdentificationCodeIdentifier"/>
 *         <element name="PLKNR" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}PolishNationalClearingCodeIdentifier"/>
 *         <element name="OthrClrCdId" type="{urn:iso:std:iso:20022:tech:xsd:sese.011.001.09}Max35Text"/>
 *       </choice>
 *     </restriction>
 *   </complexContent>
 * </complexType>
