 ...
 *       <sequence>
 *         <element name="TaxEffcntPdctTp" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}TaxEfficientProductType2Choice"/>
 *         <element name="CurYr" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}YesNoIndicator" minOccurs="0"/>
 *         <element name="CshCmpntInd" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}YesNoIndicator" minOccurs="0"/>
 *         <element name="PrvsYrs" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}PreviousYear4" minOccurs="0"/>
 *         <element name="PrvsYrSbcptAmt" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}ActiveCurrencyAnd13DecimalAmount" minOccurs="0"/>
 *         <element name="PrvsYrsSbcptAmt" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}ActiveCurrencyAnd13DecimalAmount" minOccurs="0"/>
 *         <element name="DtOfFrstSbcpt" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}ISODate" minOccurs="0"/>
 *         <element name="CurYrSbcptDtls" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}SubscriptionInformation2" minOccurs="0"/>
 *         <element name="BnsOrWdrwl" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}BonusWithdrawal2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="WdrwlForResdtlPurchsPrgrs" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}YesNoIndicator" minOccurs="0"/>
 *         <element name="TrfrAltrnId" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}Max35Text" minOccurs="0"/>
 *         <element name="TtlSbcptAmt" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}ActiveCurrencyAndAmount" minOccurs="0"/>
 *         <element name="OthrAmt" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}OtherAmount3" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="DtFrstQlfygAddtn" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}ISODate" minOccurs="0"/>
 *         <element name="InvstrTaxRef" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}TaxReference2" minOccurs="0"/>
 *         <element name="InvstmtsToFllwVal" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}DateAndAmount2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="InnvtvFinc" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}InnovativeFinance1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="LwstInvstdAmtCurYr" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}ActiveCurrencyAnd13DecimalAmount" minOccurs="0"/>
 *         <element name="TaxClctnBase" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}ActiveCurrencyAnd13DecimalAmount" minOccurs="0"/>
 *         <element name="UusdTaxDdctn" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}ActiveCurrencyAnd13DecimalAmount" minOccurs="0"/>
 *         <element name="CurInvstmtAmt" type="{urn:iso:std:iso:20022:tech:xsd:sese.013.001.11}ActiveCurrencyAnd13DecimalAmount" minOccurs="0"/>
