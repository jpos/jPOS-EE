...
/**
 * <p>Java class for AccountHoldingInformationRequestV08 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="AccountHoldingInformationRequestV08">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="MsgRef" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}MessageIdentification1"/>
 *         <element name="PoolRef" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}AdditionalReference11" minOccurs="0"/>
 *         <element name="PrvsRef" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}AdditionalReference10" minOccurs="0"/>
 *         <element name="RltdRef" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}AdditionalReference10" minOccurs="0"/>
 *         <element name="BizFlowDrctnTp" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}BusinessFlowDirectionType1Code" minOccurs="0"/>
 *         <element name="PmryIndvInvstr" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}IndividualPerson8" minOccurs="0"/>
 *         <element name="ScndryIndvInvstr" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}IndividualPerson8" minOccurs="0"/>
 *         <element name="OthrIndvInvstr" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}IndividualPerson8" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PmryCorpInvstr" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}Organisation36" minOccurs="0"/>
 *         <element name="ScndryCorpInvstr" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}Organisation36" minOccurs="0"/>
 *         <element name="OthrCorpInvstr" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}Organisation36" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TrfrAcct" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}InvestmentAccount69"/>
 *         <element name="NmneeAcct" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}InvestmentAccount69" minOccurs="0"/>
 *         <element name="Trfee" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}PartyIdentification132"/>
 *         <element name="PdctTrf" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}PortfolioTransfer12" maxOccurs="unbounded"/>
 *         <element name="MktPrctcVrsn" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}MarketPracticeVersion1" minOccurs="0"/>
 *         <element name="Xtnsn" type="{urn:iso:std:iso:20022:tech:xsd:sese.019.001.08}Extension1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class AccountHoldingInformationRequestV08 {
     ...
     *     
     */
    public void setBizFlowDrctnTp(BusinessFlowDirectionType1Code value) {
