 ...
 *       <sequence>
 *         <element name="TradId" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}RestrictedFINXMax52Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CollTxId" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}RestrictedFINXMax16Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PlcOfTrad" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}PlaceOfTradeIdentification2" minOccurs="0"/>
 *         <element name="PlcOfClr" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}PlaceOfClearingIdentification2" minOccurs="0"/>
 *         <element name="TradDt" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}TradeDate9Choice" minOccurs="0"/>
 *         <element name="SttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}SettlementDate20Choice" minOccurs="0"/>
 *         <element name="FctvSttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}SettlementDate22Choice"/>
 *         <element name="DealPric" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}Price11" minOccurs="0"/>
 *         <element name="NbOfDaysAcrd" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}Max3Number" minOccurs="0"/>
 *         <element name="OpngClsg" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}OpeningClosing4Choice" minOccurs="0"/>
 *         <element name="Rptg" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}Reporting9Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TradTxCond" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}TradeTransactionCondition6Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="InvstrCpcty" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}InvestorCapacity5Choice" minOccurs="0"/>
 *         <element name="TradOrgtrRole" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}TradeOriginator4Choice" minOccurs="0"/>
 *         <element name="TpOfPric" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}TypeOfPrice32Choice" minOccurs="0"/>
 *         <element name="FxAddtlDtls" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}RestrictedFINXMax350Text" minOccurs="0"/>
 *         <element name="SttlmInstrPrcgAddtlDtls" type="{urn:iso:std:iso:20022:tech:xsd:sese.025.002.11}RestrictedFINXMax350Text" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
