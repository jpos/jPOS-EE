...
/**
 * <p>Java class for SubscriptionExecution13 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="SubscriptionExecution13">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="OrdrRef" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}Max35Text"/>
 *         <element name="ClntRef" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}Max35Text" minOccurs="0"/>
 *         <element name="DealRef" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}Max35Text"/>
 *         <element name="OrdrTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}FundOrderType4Choice" maxOccurs="10" minOccurs="0"/>
 *         <element name="FinInstrmDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}FinancialInstrument57"/>
 *         <element name="SubAcctForHldg" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}SubAccount6" minOccurs="0"/>
 *         <element name="UnitsNb" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}DecimalNumber"/>
 *         <element name="Rndg" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}RoundingDirection2Code" minOccurs="0"/>
 *         <element name="NetAmt" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ActiveCurrencyAndAmount" minOccurs="0"/>
 *         <element name="GrssAmt" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ActiveCurrencyAndAmount" minOccurs="0"/>
 *         <element name="TradDtTm" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}DateAndDateTimeChoice"/>
 *         <element name="DealgPricDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}UnitPrice22"/>
 *         <element name="InftvPricDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}UnitPrice22" maxOccurs="2" minOccurs="0"/>
 *         <element name="SttlmAmt" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ActiveCurrencyAndAmount"/>
 *         <element name="CshSttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ISODate" minOccurs="0"/>
 *         <element name="SttlmMtd" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}DeliveryReceiptType2Code" minOccurs="0"/>
 *         <element name="PrtlyExctdInd" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}YesNoIndicator"/>
 *         <element name="BestExctn" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}BestExecution1Code" minOccurs="0"/>
 *         <element name="CumDvddInd" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}YesNoIndicator"/>
 *         <element name="IntrmPrftAmt" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ProfitAndLoss2Choice" minOccurs="0"/>
 *         <element name="FXDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ForeignExchangeTerms33" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="IncmPref" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}IncomePreference1Code" minOccurs="0"/>
 *         <element name="LttrInttRef" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}Max35Text" minOccurs="0"/>
 *         <element name="AcmltnRghtRef" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}Max35Text" minOccurs="0"/>
 *         <element name="TxOvrhd" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}TotalFeesAndTaxes40" minOccurs="0"/>
 *         <element name="InftvTaxDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}InformativeTax1" minOccurs="0"/>
 *         <element name="SttlmAndCtdyDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}FundSettlementParameters12" minOccurs="0"/>
 *         <element name="PhysDlvryInd" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}YesNoIndicator"/>
 *         <element name="PhysDlvryDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}DeliveryParameters3" minOccurs="0"/>
 *         <element name="ReqdSttlmCcy" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ActiveCurrencyCode" minOccurs="0"/>
 *         <element name="ReqdNAVCcy" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ActiveOrHistoricCurrencyCode" minOccurs="0"/>
 *         <element name="Rfnd" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ActiveCurrencyAndAmount" minOccurs="0"/>
 *         <element name="SbcptIntrst" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}ActiveCurrencyAndAmount" minOccurs="0"/>
 *         <element name="CshSttlmDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}PaymentTransaction70" minOccurs="0"/>
 *         <element name="NonStdSttlmInf" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}Max350Text" minOccurs="0"/>
 *         <element name="PrtlSttlmOfUnits" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}PercentageRate" minOccurs="0"/>
 *         <element name="PrtlSttlmOfCsh" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}PercentageRate" minOccurs="0"/>
 *         <element name="StffClntBrkdwn" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}InvestmentFundsOrderBreakdown2" maxOccurs="4" minOccurs="0"/>
 *         <element name="FinAdvc" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}FinancialAdvice1Code" minOccurs="0"/>
 *         <element name="NgtdTrad" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}NegotiatedTrade1Code" minOccurs="0"/>
 *         <element name="LateRpt" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}LateReport1Code" minOccurs="0"/>
 *         <element name="RltdPtyDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}Intermediary39" maxOccurs="10" minOccurs="0"/>
 *         <element name="Equlstn" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}Equalisation1" minOccurs="0"/>
 *         <element name="SrcOfCsh" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}SourceOfCash1Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CstmrCndctClssfctn" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}CustomerConductClassification1Choice" minOccurs="0"/>
 *         <element name="TxChanlTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}TransactionChannelType1Choice" minOccurs="0"/>
 *         <element name="SgntrTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}SignatureType1Choice" minOccurs="0"/>
 *         <element name="OrdrWvrDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.012.001.04}OrderWaiver1" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class SubscriptionExecution13 {
     ...
     *     
     */
    public void setSubAcctForHldg(SubAccount6 value) {
