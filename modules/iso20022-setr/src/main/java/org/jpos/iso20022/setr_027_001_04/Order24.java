...
/**
 * <p>Java class for Order24 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="Order24">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="BizPrcTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}BusinessProcessType2Choice" minOccurs="0"/>
 *         <element name="OrdrId" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ClntOrdrId" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ScndryClntOrdrId" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ListId" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Sd" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Side3Code"/>
 *         <element name="Pmt" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}DeliveryReceiptType2Code" minOccurs="0"/>
 *         <element name="TradTxTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}TradeType4Choice" minOccurs="0"/>
 *         <element name="TradTxCond" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}TradeTransactionCondition9Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PreAdvc" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}YesNoIndicator" minOccurs="0"/>
 *         <element name="PlcOfTrad" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}MarketIdentification93" minOccurs="0"/>
 *         <element name="OrdrBookgDt" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}ISODate" minOccurs="0"/>
 *         <element name="TradOrgtnDt" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}ISODateTime" minOccurs="0"/>
 *         <element name="TradDt" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}TradeDate7Choice"/>
 *         <element name="PrcgDt" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}TradeDate7Choice" minOccurs="0"/>
 *         <element name="SttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}SettlementDate16Choice"/>
 *         <element name="NAVDt" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}DateAndDateTime1Choice" minOccurs="0"/>
 *         <element name="PrtlFillDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}PartialFill4" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ConfQty" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Quantity6Choice"/>
 *         <element name="QtyBrkdwn" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}QuantityBreakdown76" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="TpOfPric" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}TypeOfPrice47Choice" minOccurs="0"/>
 *         <element name="CshMrgn" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}CashMarginOrder1Code" minOccurs="0"/>
 *         <element name="Comssn" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Commission24" minOccurs="0"/>
 *         <element name="NbOfDaysAcrd" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Max3Number" minOccurs="0"/>
 *         <element name="GvUpNbOfDays" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Max3Number" minOccurs="0"/>
 *         <element name="IntrstTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}InterestType2Code" minOccurs="0"/>
 *         <element name="AcrdIntrstAmt" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}AmountAndDirection29" minOccurs="0"/>
 *         <element name="AcrdIntrstPctg" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}PercentageRate" minOccurs="0"/>
 *         <element name="TradRgltryCondsTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}TradeRegulatoryConditions1Code" minOccurs="0"/>
 *         <element name="CcyToBuyOrSell" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}CurrencyToBuyOrSell1Choice" minOccurs="0"/>
 *         <element name="OrdrOrgtrElgblty" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Eligibility1Code" minOccurs="0"/>
 *         <element name="PosFct" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}PositionEffect2Code" minOccurs="0"/>
 *         <element name="DerivCvrd" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}YesNoIndicator" minOccurs="0"/>
 *         <element name="ChrgTaxBsisTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}ChargeTaxBasisType2Choice" minOccurs="0"/>
 *         <element name="CptlGnTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}EUCapitalGainType3Choice" minOccurs="0"/>
 *         <element name="MtchSts" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}MatchingStatus27Choice" minOccurs="0"/>
 *         <element name="CallInTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}CallIn1Code" minOccurs="0"/>
 *         <element name="YldTp" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}YieldCalculation7" minOccurs="0"/>
 *         <element name="Rptg" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Reporting6Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlPhysOrRegnDtls" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}RegistrationParameters3" minOccurs="0"/>
 *         <element name="AddtlTradInstrPrcgInf" type="{urn:iso:std:iso:20022:tech:xsd:setr.027.001.04}Max350Text" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class Order24 {
     ...
     *     
     */
    public void setComssn(Commission24 value) {
        this.comssn = value;
    }
