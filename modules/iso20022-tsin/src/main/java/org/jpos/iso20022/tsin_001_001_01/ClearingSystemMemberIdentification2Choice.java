 ...
 *       <choice>
 *         <element name="USCHU" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}CHIPSUniversalIdentifier"/>
 *         <element name="NZNCC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}NewZealandNCCIdentifier"/>
 *         <element name="IENSC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}IrishNSCIdentifier"/>
 *         <element name="GBSC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}UKDomesticSortCodeIdentifier"/>
 *         <element name="USCH" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}CHIPSParticipantIdentifier"/>
 *         <element name="CHBC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}SwissBCIdentifier"/>
 *         <element name="USFW" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}FedwireRoutingNumberIdentifier"/>
 *         <element name="PTNCC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}PortugueseNCCIdentifier"/>
 *         <element name="RUCB" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}RussianCentralBankIdentificationCodeIdentifier"/>
 *         <element name="ITNCC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}ItalianDomesticIdentifier"/>
 *         <element name="ATBLZ" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}AustrianBankleitzahlIdentifier"/>
 *         <element name="CACPA" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}CanadianPaymentsARNIdentifier"/>
 *         <element name="CHSIC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}SwissSICIdentifier"/>
 *         <element name="DEBLZ" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}GermanBankleitzahlIdentifier"/>
 *         <element name="ESNCC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}SpanishDomesticInterbankingIdentifier"/>
 *         <element name="ZANCC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}SouthAfricanNCCIdentifier"/>
 *         <element name="HKNCC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}HongKongBankIdentifier"/>
 *         <element name="AUBSBx" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}ExtensiveBranchNetworkIdentifier"/>
 *         <element name="AUBSBs" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}SmallNetworkIdentifier"/>
 *         <element name="INIFSC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}IndianFinancialSystemCodeIdentifier"/>
 *         <element name="GRHEBIC" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}HellenicBankIdentificationCodeIdentifier"/>
 *         <element name="PLKNR" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}PolishNationalClearingCodeIdentifier"/>
 *         <element name="OthrClrCdId" type="{urn:iso:std:iso:20022:tech:xsd:tsin.001.001.01}Max35Text"/>
 *       </choice>
 *     </restriction>
 *   </complexContent>
 * </complexType>
