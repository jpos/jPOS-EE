 ...
 * generated in the org.jpos.iso20022.tsin_008_001_01 package. 
...
public class ObjectFactory {
    ...
    private static final QName _Document_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", "Document");
    private static final QName _FinancingNotificationParties1AckRcvr_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", "AckRcvr");
    private static final QName _FinancingItemList1RltdDoc_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", "RltdDoc");
    private static final QName _FinancialItemParameters1RltdItm_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", "RltdItm");
    private static final QName _FinancialItemParameters1GovngCtrct_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", "GovngCtrct");
    private static final QName _FinancialItem1FinDocRef_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", "FinDocRef");
    private static final QName _FinancialItem1AssoctdDoc_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", "AssoctdDoc");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.jpos.iso20022.tsin_008_001_01
     * 
     */
    ...
    /**
     * Create an instance of {@link InvoiceAssignmentNotificationV01 }
     * 
     * @return
     *     the new instance of {@link InvoiceAssignmentNotificationV01 }
     */
    public InvoiceAssignmentNotificationV01 createInvoiceAssignmentNotificationV01() {
        return new InvoiceAssignmentNotificationV01();
    }
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", name = "Document")
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", name = "AckRcvr", scope = FinancingNotificationParties1 .class)
    @XmlIDREF
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", name = "RltdDoc", scope = FinancingItemList1 .class)
    @XmlIDREF
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", name = "RltdItm", scope = FinancialItemParameters1 .class)
    @XmlIDREF
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", name = "GovngCtrct", scope = FinancialItemParameters1 .class)
    @XmlIDREF
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", name = "FinDocRef", scope = FinancialItem1 .class)
    @XmlIDREF
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.008.001.01", name = "AssoctdDoc", scope = FinancialItem1 .class)
    @XmlIDREF
