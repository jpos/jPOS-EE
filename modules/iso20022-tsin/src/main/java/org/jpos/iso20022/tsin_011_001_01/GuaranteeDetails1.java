 ...
 *         <element name="Desc" type="{urn:iso:std:iso:20022:tech:xsd:tsin.011.001.01}Max2000Text" minOccurs="0"/>
 *         <element name="GrntedAmt" type="{urn:iso:std:iso:20022:tech:xsd:tsin.011.001.01}AmountAndPeriod1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Xcss" type="{urn:iso:std:iso:20022:tech:xsd:tsin.011.001.01}AmountAndPeriod1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CvrdPctg" type="{urn:iso:std:iso:20022:tech:xsd:tsin.011.001.01}PercentageAndPeriod1" maxOccurs="unbounded" minOccurs="0"/>
