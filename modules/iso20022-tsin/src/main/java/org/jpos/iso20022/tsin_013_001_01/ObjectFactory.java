 ...
 * generated in the org.jpos.iso20022.tsin_013_001_01 package. 
...
public class ObjectFactory {
    ...
    private static final QName _Document_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "Document");
    private static final QName _FinancingNotificationParties1AckRcvr_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "AckRcvr");
    private static final QName _FinancingItemList1RltdDoc_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "RltdDoc");
    private static final QName _FinancialItemParameters1RltdItm_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "RltdItm");
    private static final QName _FinancialItemParameters1GovngCtrct_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "GovngCtrct");
    private static final QName _FinancialItem1FinDocRef_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "FinDocRef");
    private static final QName _FinancialItem1AssoctdDoc_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "AssoctdDoc");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.jpos.iso20022.tsin_013_001_01
     * 
     */
     ...
     * 
     * @return
     *     the new instance of {@link InvoiceAssignmentAcknowledgementV01 }
     */
