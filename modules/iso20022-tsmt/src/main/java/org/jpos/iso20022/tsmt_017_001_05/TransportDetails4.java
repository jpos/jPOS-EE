 ...
 *       <sequence>
 *         <element name="TrnsprtDocRef" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05}DocumentIdentification7" maxOccurs="unbounded"/>
 *         <element name="TrnsprtdGoods" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05}TransportedGoods1" maxOccurs="unbounded"/>
 *         <element name="Consgnmt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05}Consignment3" minOccurs="0"/>
 *         <element name="RtgSummry" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05}TransportMeans6"/>
 *         <element name="ShipmntDt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05}ShipmentDate1Choice"/>
