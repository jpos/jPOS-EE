 ...
 *       <sequence>
 *         <element name="SubmitrBaselnId" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}DocumentIdentification1"/>
 *         <element name="SvcCd" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}TradeFinanceService2Code"/>
 *         <element name="PurchsOrdrRef" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}DocumentIdentification7"/>
 *         <element name="Buyr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}PartyIdentification26"/>
 *         <element name="Sellr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}PartyIdentification26"/>
 *         <element name="BuyrBk" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}BICIdentification1"/>
 *         <element name="SellrBk" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}BICIdentification1"/>
 *         <element name="BuyrSdSubmitgBk" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}BICIdentification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SellrSdSubmitgBk" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}BICIdentification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="BllTo" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}PartyIdentification26" minOccurs="0"/>
 *         <element name="ShipTo" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}PartyIdentification26" minOccurs="0"/>
 *         <element name="Consgn" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}PartyIdentification26" minOccurs="0"/>
 *         <element name="Goods" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}LineItem13"/>
 *         <element name="PmtTerms" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}PaymentTerms5" maxOccurs="unbounded"/>
 *         <element name="SttlmTerms" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}SettlementTerms3" minOccurs="0"/>
 *         <element name="PmtOblgtn" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}PaymentObligation2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="LatstMtchDt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}ISODate" minOccurs="0"/>
 *         <element name="ComrclDataSetReqrd" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}RequiredSubmission2"/>
 *         <element name="TrnsprtDataSetReqrd" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}RequiredSubmission2" minOccurs="0"/>
 *         <element name="InsrncDataSetReqrd" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}RequiredSubmission3" minOccurs="0"/>
 *         <element name="CertDataSetReqrd" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}RequiredSubmission4" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="OthrCertDataSetReqrd" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}RequiredSubmission6" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="InttToPayXpctd" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.018.001.05}YesNoIndicator"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
