 ...
 *       <sequence>
 *         <element name="LineItmId" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}Max70Text"/>
 *         <element name="Qty" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}Quantity9"/>
 *         <element name="QtyTlrnce" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}PercentageTolerance1" minOccurs="0"/>
 *         <element name="UnitPric" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}UnitPrice18" minOccurs="0"/>
 *         <element name="PricTlrnce" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}PercentageTolerance1" minOccurs="0"/>
 *         <element name="PdctNm" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}Max70Text" minOccurs="0"/>
 *         <element name="PdctIdr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}ProductIdentifier2Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PdctChrtcs" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}ProductCharacteristics1Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PdctCtgy" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}ProductCategory1Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PdctOrgn" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}CountryCode" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="ShipmntSchdl" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}ShipmentSchedule2Choice" minOccurs="0"/>
 *         <element name="RtgSummry" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}TransportMeans5" minOccurs="0"/>
 *         <element name="Adjstmnt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}Adjustment7" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FrghtChrgs" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}Charge24" minOccurs="0"/>
 *         <element name="Tax" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}Tax23" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TtlAmt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}CurrencyAndAmount"/>
 *         <element name="Incotrms" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05}Incoterms4" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
