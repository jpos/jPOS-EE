 ...
 *       <sequence>
 *         <element name="ApplCntxt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}Max35Text" minOccurs="0"/>
 *         <element name="LttrIdr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedDocumentInformation1"/>
 *         <element name="Dt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}ISODate"/>
 *         <element name="RltdLttr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedDocumentInformation1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="RltdMsg" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedDocumentInformation1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CnttIdr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="InstrPrty" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}Priority3Code" minOccurs="0"/>
 *         <element name="Orgtr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedPartyIdentification1"/>
 *         <element name="PmryRcpt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedPartyIdentification1" maxOccurs="unbounded"/>
 *         <element name="Sndr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedPartyIdentification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AuthstnUsr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedPartyIdentification1" maxOccurs="unbounded"/>
 *         <element name="RspnRcpt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedPartyIdentification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CpyRcpt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedPartyIdentification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="OthrPty" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedPartyIdentification1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AssoctdDoc" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedDocumentInformation1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="GovngCtrct" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedDocumentInformation1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="LglCntxt" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}GovernanceRules2" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}Max2000Text" minOccurs="0"/>
 *         <element name="Ntce" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}Max350Text" minOccurs="0"/>
 *         <element name="VldtnStsInf" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}ValidationStatusInformation1" minOccurs="0"/>
 *         <element name="DgtlSgntr" type="{urn:iso:std:iso:20022:tech:xsd:tsmt.053.001.01}QualifiedPartyAndXMLSignature1" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
