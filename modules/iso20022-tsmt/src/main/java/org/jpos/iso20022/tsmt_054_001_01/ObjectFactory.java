 ...
 * generated in the org.jpos.iso20022.tsmt_054_001_01 package. 
...
public class ObjectFactory {
    ...
    private static final QName _Document_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", "Document");
    private static final QName _ReconciliationList1RltdDoc_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", "RltdDoc");
    private static final QName _ReconciliationList1AssoctdDoc_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", "AssoctdDoc");
    private static final QName _FinancialItemParameters1RltdItm_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", "RltdItm");
    private static final QName _FinancialItemParameters1GovngCtrct_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", "GovngCtrct");
    private static final QName _FinancialItem1FinDocRef_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", "FinDocRef");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.jpos.iso20022.tsmt_054_001_01
     * 
     */
    ...
    /**
     * Create an instance of {@link InvoicePaymentReconciliationStatusV01 }
     * 
     * @return
     *     the new instance of {@link InvoicePaymentReconciliationStatusV01 }
     */
    public InvoicePaymentReconciliationStatusV01 createInvoicePaymentReconciliationStatusV01() {
        return new InvoicePaymentReconciliationStatusV01();
    }
    ...
    /**
     * Create an instance of {@link PaymentPeriod1 }
     * 
     * @return
     *     the new instance of {@link PaymentPeriod1 }
     */
    public PaymentPeriod1 createPaymentPeriod1() {
        return new PaymentPeriod1();
    }

    /**
     * Create an instance of {@link PaymentTerms6 }
     * 
     * @return
     *     the new instance of {@link PaymentTerms6 }
     */
    public PaymentTerms6 createPaymentTerms6() {
        return new PaymentTerms6();
    }
    ...
    /**
     * Create an instance of {@link ReconciliationList1 }
     * 
     * @return
     *     the new instance of {@link ReconciliationList1 }
     */
    public ReconciliationList1 createReconciliationList1() {
        return new ReconciliationList1();
    }
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", name = "Document")
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", name = "RltdDoc", scope = ReconciliationList1 .class)
    @XmlIDREF
    public JAXBElement<Object> createReconciliationList1RltdDoc(Object value) {
        return new JAXBElement<>(_ReconciliationList1RltdDoc_QNAME, Object.class, ReconciliationList1 .class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", name = "AssoctdDoc", scope = ReconciliationList1 .class)
    @XmlIDREF
    public JAXBElement<Object> createReconciliationList1AssoctdDoc(Object value) {
        return new JAXBElement<>(_ReconciliationList1AssoctdDoc_QNAME, Object.class, ReconciliationList1 .class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", name = "RltdItm", scope = FinancialItemParameters1 .class)
    @XmlIDREF
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", name = "GovngCtrct", scope = FinancialItemParameters1 .class)
    @XmlIDREF
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", name = "FinDocRef", scope = FinancialItem1 .class)
    @XmlIDREF
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01", name = "AssoctdDoc", scope = FinancialItem1 .class)
    @XmlIDREF
    public JAXBElement<Object> createFinancialItem1AssoctdDoc(Object value) {
        return new JAXBElement<>(_ReconciliationList1AssoctdDoc_QNAME, Object.class, FinancialItem1 .class, value);
    }
